...
'use strict';
var $asm06 = JSIL.DeclareAssembly("Fusee.Engine.Imp.Graphics.Web, Version=0.7.0.0, Culture=neutral, PublicKeyToken=null");
...
/* class Fusee.Engine.Imp.Graphics.Web.Font */ 

(function Font$Members () {
  var $, $thisType;
  var $T00 = function () {
    return ($T00 = JSIL.Memoize(System.Array.Of($asm03.Fusee.Engine.Common.CharInfoStruct))) ();
  };
  var $T01 = function () {
  ...
  var $T03 = function () {
    return ($T03 = JSIL.Memoize($asm03.Fusee.Engine.Common.ITexture)) ();
  };
  var $T04 = function () {
  ...
  function Font_get_CharInfo () {
    return this.Font$CharInfo$value;
  }; 

  function Font_get_FontSize () {
    return this.Font$FontSize$value;
  }; 

  function Font_get_Height () {
    return this.Font$Height$value;
  }; 

  function Font_get_TexAtlas () {
    return this.Font$TexAtlas$value;
  }; 

  function Font_get_UseKerning () {
    return this.Font$UseKerning$value;
  }; 
  ...
  function Font_set_CharInfo (value) {
    this.Font$CharInfo$value = value;
  }; 

  function Font_set_FontSize (value) {
    this.Font$FontSize$value = (value >>> 0);
  }; 

  function Font_set_Height (value) {
    this.Font$Height$value = (value | 0);
  }; 

  function Font_set_TexAtlas (value) {
    this.Font$TexAtlas$value = value;
  }; 

  function Font_set_UseKerning (value) {
    this.Font$UseKerning$value = value;
  }; 

  function Font_set_Width (value) {
    this.Font$Width$value = (value | 0);
  }; 

  JSIL.MakeType({
      BaseType: $asm0F.TypeRef("System.Object"), 
      Name: "Fusee.Engine.Imp.Graphics.Web.Font", 
      IsPublic: false, 
    ...
    $.Method({Static:false, Public:true , Virtual:true }, "get_CharInfo", 
      JSIL.MethodSignature.Return($jsilcore.TypeRef("System.Array", [$asm03.TypeRef("Fusee.Engine.Common.CharInfoStruct")])), 
      Font_get_CharInfo
    )
      .Attribute($asm0F.TypeRef("System.Runtime.CompilerServices.CompilerGeneratedAttribute"));

    $.Method({Static:false, Public:true , Virtual:true }, "get_FontSize", 
    ...
    $.Method({Static:false, Public:true , Virtual:true }, "get_TexAtlas", 
    ...
    $.Method({Static:false, Public:false}, "set_CharInfo", 
      JSIL.MethodSignature.Action($jsilcore.TypeRef("System.Array", [$asm03.TypeRef("Fusee.Engine.Common.CharInfoStruct")])), 
      Font_set_CharInfo
    )
      .Attribute($asm0F.TypeRef("System.Runtime.CompilerServices.CompilerGeneratedAttribute"));

    $.Method({Static:false, Public:false}, "set_FontSize", 
    ...
    $.Method({Static:false, Public:false}, "set_TexAtlas", 
    ...
    $.Field({Static:false, Public:false}, "Font$TexAtlas$value", $asm03.TypeRef("Fusee.Engine.Common.ITexture"))
      .Attribute($asm0F.TypeRef("System.Runtime.CompilerServices.CompilerGeneratedAttribute"));

    $.Field({Static:false, Public:false}, "Font$Width$value", $.Int32)
      .Attribute($asm0F.TypeRef("System.Runtime.CompilerServices.CompilerGeneratedAttribute"));

    $.Field({Static:false, Public:false}, "Font$Height$value", $.Int32)
      .Attribute($asm0F.TypeRef("System.Runtime.CompilerServices.CompilerGeneratedAttribute"));

    $.Field({Static:false, Public:false}, "Font$FontSize$value", $.UInt32)
      .Attribute($asm0F.TypeRef("System.Runtime.CompilerServices.CompilerGeneratedAttribute"));

    $.Field({Static:false, Public:false}, "Font$UseKerning$value", $.Boolean)
      .Attribute($asm0F.TypeRef("System.Runtime.CompilerServices.CompilerGeneratedAttribute"));

    $.Field({Static:false, Public:false}, "Font$CharInfo$value", $jsilcore.TypeRef("System.Array", [$asm03.TypeRef("Fusee.Engine.Common.CharInfoStruct")]))
      .Attribute($asm0F.TypeRef("System.Runtime.CompilerServices.CompilerGeneratedAttribute"));

    $.Property({Static:false, Public:true , Virtual:true }, "TexAtlas", $asm03.TypeRef("Fusee.Engine.Common.ITexture"));

    $.Property({Static:false, Public:true , Virtual:true }, "Width", $.Int32);

    $.Property({Static:false, Public:true , Virtual:true }, "Height", $.Int32);

    $.Property({Static:false, Public:true , Virtual:true }, "FontSize", $.UInt32);

    $.Property({Static:false, Public:true , Virtual:true }, "UseKerning", $.Boolean);

    $.Property({Static:false, Public:true , Virtual:true }, "CharInfo", $jsilcore.TypeRef("System.Array", [$asm03.TypeRef("Fusee.Engine.Common.CharInfoStruct")]));

    $.ImplementInterfaces(
      /* 0 */ $asm03.TypeRef("Fusee.Engine.Common.IFont")
    );
...
(function KeyboardDeviceImp$Members () {
  ...
  function KeyboardDeviceImp__ctor (canvas) {
    ...
    var enumerator = (JSIL.GetEnumerator($T03().GetNames($T04().__Type__)));

    for (var enumerator2 = (JSIL.GetEnumerator($T03().GetValues($T04().__Type__))); $IM00().Call(enumerator2, null) & $IM00().Call(enumerator, null); ) {
      var arg_7E_0 = this._keyDescriptions;
      var arg_7E_1 = $T08().$Cast($IM01().Call(enumerator2, null));
      var value = new ($T09())();
      value.Id = $T08().$Cast($IM01().Call(enumerator2, null));
      value.Name = $T06().$Cast($IM01().Call(enumerator, null));
  ...
  function KeyboardDeviceImp_GetAxis (iAxisId) {
    throw $S01().Construct($T06().Format("Unsopported axis {0}. This device does not support any axis at all.", $T08().$Box(iAxisId)));
  }; 

  function KeyboardDeviceImp_GetButton (iButtonId) {
    throw $S01().Construct($T06().Format("Button {0} does not exist or is no pollable. Listen to the ButtonValueChanged event to reveive keyboard notifications from this device.", $T08().$Box(iButtonId)));
  }; 
...
(function MouseDeviceImp$Members () {
  ...
  function MouseDeviceImp_GetAxis (iAxisId) {
    switch (iAxisId) {
      ...
      default: 
        throw $S00().Construct($T13().Format("Unknown axis {0}. Cannot get value for unknown axis.", $T10().$Box(iAxisId)));
  ...
  function MouseDeviceImp_GetButton (iButtonId) {
    throw $S00().Construct($T13().Format("Unsopported axis {0}. This device does not support any to-be polled axes at all.", $T10().$Box(iButtonId)));
  }; 
...
(function TouchDeviceImp$Members () {
  ...
  var $S03 = function () {
    return ($S03 = JSIL.Memoize(new JSIL.ConstructorSignature($asm0F.System.InvalidOperationException, [$asm0F.System.String]))) ();
  };
  ...
  function TouchDeviceImp__ctor (canvas) {
    ...
    for (var i = 0; i < (this._nTouchPointsSupported | 0); i = ((i + 1) | 0)) {
      var num = ((Math.imul(2, i) + 6) | 0);
      var arg_2EA_0 = this._tpAxisDescs;
      var arg_2EA_1 = num;
      value = new ($T03())();
      axisDesc = new ($T04())();
      axisDesc.Name = $T09().Format("Touchpoint {0} X", $T08().$Box(num));
      axisDesc.Id = num;
      axisDesc.Direction = $T05().X;
      axisDesc.Nature = $T06().Position;
      axisDesc.Bounded = $T07().OtherAxis;
      ...
      arg_2EA_0.set_Item(arg_2EA_1, value.MemberwiseClone());
      num = ((num + 1) | 0);
      var arg_36B_0 = this._tpAxisDescs;
      var arg_36B_1 = num;
      value = new ($T03())();
      axisDesc = new ($T04())();
      axisDesc.Name = $T09().Format("Touchpoint {0} Y", $T08().$Box(num));
      axisDesc.Id = num;
      axisDesc.Direction = $T05().Y;
      axisDesc.Nature = $T06().Position;
      axisDesc.Bounded = $T07().OtherAxis;
  ...
  function TouchDeviceImp_get_NextFreeTouchIndex () {
    var $s00 = new JSIL.MethodSignature($asm0F.System.Boolean, [$asm0F.TypeRef("System.Collections.Generic.IEnumerable`1", ["!!0"]), "!!0"], ["TSource"]);

    for (var i = 0; i < (this._nTouchPointsSupported | 0); i = ((i + 1) | 0)) {
      var flag = !$s00.CallStatic($T14(), "Contains$b1", [$asm0F.System.Int32], (this._activeTouchpoints).get_Values(), i);
      if (flag) {
        var result = i;
        return result;
      }
  ...
  function TouchDeviceImp_GetAxis (iAxisId) {
    switch (iAxisId) {
      ...
      default: 
        throw $S03().Construct($T09().Format("Unknown axis {0}.  Probably an event based axis or unsupported by this device.", $T08().$Box(iAxisId)));
  ...
  function TouchDeviceImp_GetButton (iButtonId) {
    throw $S03().Construct($T09().Format("Unknown button id {0}. This device supports no pollable buttons at all.", $T08().$Box(iButtonId)));
  }; 
  ...
  function TouchDeviceImp_OnCanvasTouchCancel (id, x, y) {
    ...
    var flag = !(this._activeTouchpoints).TryGetValue(id, /* ref */ num);
    if (!flag) {
      var expr_1E = this.ButtonValueChanged;
      if (expr_1E !== null) {
        var expr_2A = new ($T17())();
        expr_2A.Button = (this._tpButtonDescs).get_Item(((1 + (num.get() | 0)) | 0)).ButtonDesc.MemberwiseClone();
  ...
  function TouchDeviceImp_OnCanvasTouchEnd (id, x, y) {
    ...
    if (!flag) {
      ...
      if (expr_21 !== null) {
        var expr_2D = new ($T18())();
        expr_2D.Axis = (this._tpAxisDescs).get_Item(((6 + Math.imul(2, num.get())) | 0)).AxisDesc.MemberwiseClone();
        expr_2D.Value = +x;
      ...
      if (expr_5B !== null) {
        var expr_67 = new ($T18())();
        expr_67.Axis = (this._tpAxisDescs).get_Item(((7 + Math.imul(2, num.get())) | 0)).AxisDesc.MemberwiseClone();
        expr_67.Value = +y;
      ...
      if (expr_95 !== null) {
        var expr_A1 = new ($T17())();
        expr_A1.Button = (this._tpButtonDescs).get_Item(((1 + (num.get() | 0)) | 0)).ButtonDesc.MemberwiseClone();
  ...
  function TouchDeviceImp_OnCanvasTouchMove (id, x, y) {
    ...
    if (!flag) {
      ...
      if (expr_1E !== null) {
        var expr_2A = new ($T18())();
        expr_2A.Axis = (this._tpAxisDescs).get_Item(((6 + Math.imul(2, num.get())) | 0)).AxisDesc.MemberwiseClone();
        expr_2A.Value = +x;
        expr_1E(this, expr_2A);
      }
      ...
      if (expr_58 !== null) {
        var expr_64 = new ($T18())();
        expr_64.Axis = (this._tpAxisDescs).get_Item(((7 + Math.imul(2, num.get())) | 0)).AxisDesc.MemberwiseClone();
        expr_64.Value = +y;
  ...
  function TouchDeviceImp_OnCanvasTouchStart (id, x, y) {
    ...
    if (flag) {
      throw $S03().Construct($T09().Format("HTML Touch id {0} is already tracked. Cannot track another touchpoint using this id.", $T08().$Box(id)));
    }
    var nextFreeTouchIndex = (this.get_NextFreeTouchIndex() | 0);
    if (nextFreeTouchIndex >= 0) {
      (this._activeTouchpoints).set_Item(id, nextFreeTouchIndex);
      var expr_4F = this.ButtonValueChanged;
      if (expr_4F !== null) {
        var expr_5B = new ($T17())();
        expr_5B.Button = (this._tpButtonDescs).get_Item(((1 + nextFreeTouchIndex) | 0)).ButtonDesc.MemberwiseClone();
        expr_5B.Pressed = true;
        expr_4F(this, expr_5B);
      }
      var expr_87 = this.AxisValueChanged;
      if (expr_87 !== null) {
        var expr_93 = new ($T18())();
        expr_93.Axis = (this._tpAxisDescs).get_Item(((6 + Math.imul(2, nextFreeTouchIndex)) | 0)).AxisDesc.MemberwiseClone();
        expr_93.Value = +x;
        expr_87(this, expr_93);
      }
      var expr_C1 = this.AxisValueChanged;
      if (expr_C1 !== null) {
        var expr_CD = new ($T18())();
        expr_CD.Axis = (this._tpAxisDescs).get_Item(((7 + Math.imul(2, nextFreeTouchIndex)) | 0)).AxisDesc.MemberwiseClone();
        expr_CD.Value = +y;
        expr_C1(this, expr_CD);
      }
    }
  }; 
...
(function RenderContextImp$Members () {
  ...
  function RenderContextImp_CreateWritableTexture$00 (width, height, textureFormat, $exception) {
    ...
    try {
      switch (textureFormat.valueOf()) {
        case 0: 
          result = this.CreateDepthFramebuffer(width, height);
          break;

        case 1: 
          result = this.CreateCubeMapFramebuffer(width, height);
          break;

        case 2: 
          result = this.CreateGBufferFramebuffer(width, height);
          break;

        case 3: 
          result = this.CreateRenderTargetTextureFramebuffer(width, height);
          break;
      ...
      var arg = $exception;
      $T05().Log(JSIL.ConcatString("Error creating writable Texture: ", arg));
    }
    return result;
  }; 
  ...
  $labelgroup0: 
    while (true) {
      switch ($label0) {
        case 0: /* $entry0 */ 
          var num = 1024;
          var num2 = $T08().Create(16777215, 16777215, 65535);
          try {
            num2 = stream.get_Length();
            var flag = $T08().op_LessThan(num2, $T08().Create(16777215, 127, 0));
          } catch ($exception) {
            flag = false;
          }
          var flag2 = flag;
          if (flag2) {
            num = (num2.ToNumber(4294967295, true) | 0);
          }
          var memoryStream = null;

        $loop0: 
          while (true) {
            var array = JSIL.Array.New($T0C(), num);
            var num3 = (stream.Read(array, 0, num) | 0);
            var flag3 = flag && 
            (num3 === num);
            if (flag3) {
              break $loop0;
            }
            var flag4 = memoryStream === null;
            if (flag4) {
              memoryStream = $S02().Construct();
            }
            flag = false;
            memoryStream.Write(array, 0, num3);
            if (!(stream.get_CanRead() && (num3 > 0))) {
  ...
  function RenderContextImp_GetHeaderInfo (stream) {
    var array = JSIL.Array.New($T0C(), 8);
    var binaryReader = $S03().Construct(stream);
    $S04().CallVirtual("Read", null, binaryReader, array, 0, array.length);
    stream.set_Position($T08().Create(0, 0, 0));
    var stringBuilder = $S05().Construct();
    var array2 = array;

    for (var i = 0; i < (array2.length | 0); i = ((i + 1) | 0)) {
      var b = (array2[i] | 0);
      $S06().CallVirtual("Append", null, stringBuilder, $T0C().__Type__.__PublicInterface__.$ToString(b, "X2", null));
    }
    return stringBuilder.toString();
  }; 

  function RenderContextImp_GetImageType (stream) {
    var text = (this.GetHeaderInfo(stream).toUpperCase());
    var flag = (System.String.StartsWith(text, "89504E470D0A1A0A"));
    if (flag) {
      var result = "image/png";
    } else {
      var flag2 = (System.String.StartsWith(text, "FFD8FFE0"));
      if (flag2) {
        result = "image/jpeg";
      } else {
        var flag3 = (System.String.StartsWith(text, "424D"));
        if (flag3) {
          result = "image/bmp";
        } else {
          var flag4 = (System.String.StartsWith(text, "474946"));
          if (flag4) {
            result = "image/gif";
          } else {
            var flag5 = (System.String.StartsWith(text, "49492A"));
            if (flag5) {
              result = "image/tiff";
            } else {
              result = "";
