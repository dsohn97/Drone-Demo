...
(function AABBf$Members () {
  ...
  function AABBf_op_Multiply (m, box) {
    ...
    aABBf.min = array[0].MemberwiseClone();
    aABBf.max = array[0].MemberwiseClone();

    for (var j = 1; j < 8; j = ((j + 1) | 0)) {
      var flag = +array[j].x < +aABBf.min.x;
      if (flag) {
        aABBf.min.x = +array[j].x;
      }
      var flag2 = +array[j].y < +aABBf.min.y;
      if (flag2) {
        aABBf.min.y = +array[j].y;
      }
      var flag3 = +array[j].z < +aABBf.min.z;
      if (flag3) {
        aABBf.min.z = +array[j].z;
      }
      var flag4 = +array[j].x > +aABBf.max.x;
      if (flag4) {
        aABBf.max.x = +array[j].x;
      }
      var flag5 = +array[j].y > +aABBf.max.y;
      if (flag5) {
        aABBf.max.y = +array[j].y;
      }
      var flag6 = +array[j].z > +aABBf.max.z;
      if (flag6) {
        aABBf.max.z = +array[j].z;
      }
    }
    return aABBf;
  }; 
  ...
  function Curve_CombineCurves$03 (curves) {
    ...
    try {
      ...
      while ($IM01().Call(enumerator, null)) {
        ...
        var enumerator2 = $IM03().Call(current.CurveParts, null);
        try {

          while ($IM01().Call(enumerator2, null)) {
            var current2 = $IM04().Call(enumerator2, null);
            $IM05().Call(curve.CurveParts, null, current2);
          }
        } finally {
          if (enumerator2 !== null) {
...
(function $lCalcUniformPolyline$gd__3$Members () {
  ...
  var $T08 = function () {
    return ($T08 = JSIL.Memoize($asm0F.System.Type)) ();
  };
  var $T09 = function () {
    return ($T09 = JSIL.Memoize($asm0F.System.Collections.Generic.IList$b1.Of($asm0A.Fusee.Math.Core.CurveSegment))) ();
  };
  var $T0A = function () {
    return ($T0A = JSIL.Memoize($asm0A.Fusee.Math.Core.LinearSegment)) ();
  };
  var $T0B = function () {
    return ($T0B = JSIL.Memoize($asm0A.Fusee.Math.Core.BezierConicSegment)) ();
  };
  var $T0C = function () {
    return ($T0C = JSIL.Memoize($asm0A.Fusee.Math.Core.BezierCubicSegment)) ();
  };
  var $T0D = function () {
    return ($T0D = JSIL.Memoize($asm0F.System.Collections.Generic.IList$b1.Of($asm0A.Fusee.Math.Core.float3))) ();
  };
  var $T0E = function () {
    return ($T0E = JSIL.Memoize($asm0F.System.Collections.Generic.ICollection$b1.Of($asm0A.Fusee.Math.Core.float3))) ();
  };
  var $T0F = function () {
    return ($T0F = JSIL.Memoize($asm0F.System.Collections.Generic.IEnumerable$b1.Of($asm0A.Fusee.Math.Core.float3))) ();
  };
  var $T10 = function () {
    return ($T10 = JSIL.Memoize($asm0A.Fusee.Math.Core.CurveSegment)) ();
  };
  var $T11 = function () {
    return ($T11 = JSIL.Memoize($asm0F.System.NotSupportedException)) ();
  };
  var $S00 = function () {
    return ($S00 = JSIL.Memoize(new JSIL.ConstructorSignature($asm0F.System.NotSupportedException, null))) ();
  };
        ...
        switch ($label0) {
          ...
          case 2: /* IL_1EB */ 
            if ((this.$li$g5__1 | 0) < ($IM03().Call(this.$l$g4__this.CurveSegments, null) | 0)) {
              ...
              var flag = $T08().op_Equality(JSIL.GetType($IM04().Call(this.$l$g4__this.CurveSegments, null, this.$li$g5__1)), $T0A().__Type__);
              if (flag) {
                this.$ldegree$g5__3 = 1;
              } else {
                var flag2 = $T08().op_Equality(JSIL.GetType($IM04().Call(this.$l$g4__this.CurveSegments, null, this.$li$g5__1)), $T0B().__Type__);
                if (flag2) {
                  this.$ldegree$g5__3 = 2;
                } else {
                  var flag3 = $T08().op_Equality(JSIL.GetType($IM04().Call(this.$l$g4__this.CurveSegments, null, this.$li$g5__1)), $T0C().__Type__);
                  if (flag3) {
...
(function CurveSegment$Members () {
  ...
  var $S03 = function () {
    return ($S03 = JSIL.Memoize(new JSIL.ConstructorSignature($asm0A.Fusee.Math.Core.float3x3, [
        $asm0F.System.Single, $asm0F.System.Single, 
        $asm0F.System.Single, $asm0F.System.Single, 
        $asm0F.System.Single, $asm0F.System.Single, 
        $asm0F.System.Single, $asm0F.System.Single, 
  ...
  function CurveSegment_AdaptiveSamplingWAngle (verts, angle, /* ref */ vertList) {
    ...
    var float = verts[(((verts.length | 0) - 1) | 0)].MemberwiseClone();
    var num = +$thisType.RandomT(rnd, 0.45, 0.55);
    var m = this.CalcPoint(Math.fround(num), verts);
    var flag = $thisType.IsAngleFlatEnough(a.MemberwiseClone(), m, float.MemberwiseClone(), +angle);
    var list = new JSIL.BoxedVariable(null);
    var list2 = new JSIL.BoxedVariable(null);
    if (flag) {
      (vertList.get()).Add(float.MemberwiseClone());
    } else {
      list.set($S01().Construct());
      list2.set($S01().Construct());
      this.SplitCurve(Math.fround(num), verts, /* ref */ list, /* ref */ list2);
      this.AdaptiveSamplingWAngle($T02().prototype.ToArray.call(list.get()), angle, /* ref */ vertList);
      this.AdaptiveSamplingWAngle($T02().prototype.ToArray.call(list2.get()), angle, /* ref */ vertList);
    }
  }; 
  ...
  function CurveSegment_AdaptiveSamplingWArcreage (verts, acreage, /* ref */ vertList) {
    ...
    var num = +$thisType.RandomT(rnd, 0.45, 0.55);
    var m = this.CalcPoint(Math.fround(num), verts);
    var flag = $thisType.IsArcreageSmallEnough(a, m, float, acreage);
    var list = new JSIL.BoxedVariable(null);
    var list2 = new JSIL.BoxedVariable(null);
    if (flag) {
      (vertList.get()).Add(float.MemberwiseClone());
      ...
      list2.set($S01().Construct());
      this.SplitCurve(Math.fround(num), verts, /* ref */ list, /* ref */ list2);
      this.AdaptiveSamplingWArcreage($T02().prototype.ToArray.call(list.get()), acreage, /* ref */ vertList);
      this.AdaptiveSamplingWArcreage($T02().prototype.ToArray.call(list2.get()), acreage, /* ref */ vertList);
    }
  }; 
  ...
  function CurveSegment_CalcPoint (t, vertices) {
    ...
    if (flag) {
      ...
      var array = JSIL.Array.New($T04(), (((vertices.length | 0) - 1) | 0));

      for (var i = 0; i < (array.length | 0); i = ((i + 1) | 0)) {
        var float = $T04().op_Addition(
          $S02().CallStatic($T04(), "op_Multiply", null, 1 - +t, vertices[i].MemberwiseClone()).MemberwiseClone(), 
          $S02().CallStatic($T04(), "op_Multiply", null, t, vertices[((i + 1) | 0)].MemberwiseClone())
        );
        array[i] = float.MemberwiseClone();
      }
      result = this.CalcPoint(t, array).MemberwiseClone();
    }
    return result;
  }; 
  ...
  function CurveSegment_IsAngleFlatEnough (a, m, b, threshold) {
    var first = $T04().op_Subtraction(a.MemberwiseClone(), m);
    var second = $T04().op_Subtraction(b.MemberwiseClone(), m);
    var num = +$T04().CalculateAngle(first, second);
    num = +$T0B().RadiansToDegrees(num);
    return ((num <= 180) && (num >= (180 - +threshold)));
  }; 

  function CurveSegment_IsArcreageSmallEnough (a, m, b, threshold) {
    var determinant = +($S03().Construct(1, 1, 1, (+m.x - +a.x), (+m.y - +a.y), (+m.z - +a.z), (+b.x - +a.x), (+b.y - +a.y), (+b.z - +a.z))).get_Determinant();
    var num = 0.5 * determinant;
    var flag = num < 1;
    if (flag) {
      num *= -1;
    }
  ...
  function CurveSegment_RandomT (rnd, min, max) {
    var num = +min + (+rnd.NextDouble() * (+max - +min));
    num = +$S04().CallStatic($T0D(), "Round", null, num, 2);
    var flag = !((num === 0.5));
    if (flag) {
      var result = num;
    } else {
  ...
  function CurveSegment_SplitCurve (t, vertices, /* ref */ leftCurve, /* ref */ rightCurve) {
    var flag = (vertices.length | 0) === 1;
    if (flag) {
      (leftCurve.get()).Add(vertices[0].MemberwiseClone());
      (rightCurve.get()).Add(vertices[0].MemberwiseClone());
      ...
      for (var i = 0; i < (array.length | 0); i = ((i + 1) | 0)) {
        ...
        var flag3 = i === (((array.length | 0) - 1) | 0);
        if (flag3) {
          (rightCurve.get()).Add(vertices[((i + 1) | 0)].MemberwiseClone());
        }
        var float = $T04().op_Addition(
          $S02().CallStatic($T04(), "op_Multiply", null, 1 - +t, vertices[i].MemberwiseClone()).MemberwiseClone(), 
          $S02().CallStatic($T04(), "op_Multiply", null, t, vertices[((i + 1) | 0)].MemberwiseClone())
      ...
      this.SplitCurve(t, array, /* ref */ leftCurve, /* ref */ rightCurve);
    }
  }; 
        ...
        case 0: /* $entry0 */ 
          switch (this.$l$g1__state) {
            case 0: 
              ...
              expr_3D.Add(this.startPoint.MemberwiseClone());
        ...
        switch ($label0) {
          case 0: /* $entry0 */ 
            ...
            if (num === 0) {
              ...
              expr_2E.Add(this.startPoint.MemberwiseClone());
        ...
        case 0: /* $entry0 */ 
          ...
          if ((this.$lj$g5__5 | 0) < (this.segmentsPerCurve | 0)) {
            ...
            this.$lpoint$g5__7 = $T03().op_Addition(
              $S01().CallStatic($T03(), "op_Multiply", null, 1 - +this.$lt$g5__6, this.$lverts$g5__3[0].MemberwiseClone()).MemberwiseClone(), 
              $S01().CallStatic($T03(), "op_Multiply", null, this.$lt$g5__6, this.$lverts$g5__3[1].MemberwiseClone())
            );
            this.$l$g2__current = this.$lpoint$g5__7.MemberwiseClone();
            this.$l$g1__state = 2;
            return true;
...
(function double2$Members () {
  ...
  function double2_GetBarycentric (a, b, c, point, /* ref */ u, /* ref */ v) {
    var double = $thisType.op_Subtraction(b.MemberwiseClone(), c);
    var double2 = $thisType.op_Subtraction(point.MemberwiseClone(), c);
    var double3 = $thisType.op_Subtraction(a.MemberwiseClone(), c);
    var num = (+double.y * +double3.x) - (+double.x * +double3.y);
    u.set(+((((+double.y * +double2.x) - (+double.x * +double2.y)) / num)));
    v.set(+((((+double3.x * +double2.y) - (+double3.y * +double2.x)) / num)));
  }; 
  ...
  function double2_IsTriangleCW (a, b, c) {
    var double = $thisType.op_Subtraction(b.MemberwiseClone(), c);
    var double2 = $thisType.op_Subtraction(a.MemberwiseClone(), c);
    var num = (+double2.x * +double.y) - (+double2.y * +double.x);
    return (num < 0);
  }; 
  ...
  function double2_toString () {
    return $T08().Format("({0}, {1})", $T00().$Box(this.x), $T00().$Box(this.y));
  }; 
  ...
  function double2_Transform$33 (/* ref */ vec, /* ref */ quat, /* ref */ result) {
    ...
    var quaternionD = new JSIL.BoxedVariable(new ($T09())());
    var quaternionD3 = new JSIL.BoxedVariable(new ($T09())());
    $T09().prototype._ctor.call(quaternionD.get().MemberwiseClone(), vec.get().x, vec.get().y, 0, 0);
    $T09().Invert(/* ref */ quat, /* ref */ quaternionD2);
    $S07().CallStatic($T09(), "Multiply", null, /* ref */ quat, /* ref */ quaternionD, /* ref */ quaternionD3);
    $S07().CallStatic($T09(), "Multiply", null, /* ref */ quaternionD3, /* ref */ quaternionD2, /* ref */ quaternionD);
...
(function double3$Members () {
  ...
  function double3_GetBarycentric (a, b, c, point, /* ref */ u, /* ref */ v) {
    var double = $thisType.op_Subtraction(b.MemberwiseClone(), c);
    var double2 = $thisType.op_Subtraction(a.MemberwiseClone(), c);
    var left = $thisType.op_Subtraction(point.MemberwiseClone(), c);
    var num = +$thisType.Dot(double, double);
    var num2 = +$thisType.Dot(double, double2);
    var num3 = +$thisType.Dot(double2, double2);
    var num4 = +$thisType.Dot(left, double);
    var num5 = +$thisType.Dot(left, double2);
    var num6 = (num * num3) - (num2 * num2);
    u.set(+((((num * num5) - (num2 * num4)) / num6)));
    v.set(+((((num3 * num4) - (num2 * num5)) / num6)));
  }; 
  ...
  function double3_NormalizeFast$28 () {
    var num = +$S05().CallStatic($T06(), "InverseSqrtFast", null, ((+this.x * +this.x) + (+this.y * +this.y)) + (+this.z * +this.z));
    this.x = +this.x * num;
    this.y = +this.y * num;
    this.z = +this.z * num;
  }; 
  ...
  function double3_NormalizeFast$29 (vec) {
    var num = +$S05().CallStatic($T06(), "InverseSqrtFast", null, ((+vec.x * +vec.x) + (+vec.y * +vec.y)) + (+vec.z * +vec.z));
    vec.x = +vec.x * num;
    vec.y = +vec.y * num;
    vec.z = +vec.z * num;
    return vec;
  ...
  function double3_NormalizeFast$2A (/* ref */ vec, /* ref */ result) {
    var num = +$S05().CallStatic($T06(), "InverseSqrtFast", null, ((+vec.get().x * +vec.get().x) + (+vec.get().y * +vec.get().y)) + (+vec.get().z * +vec.get().z));
    result.get().x = +vec.get().x * num;
    result.get().y = +vec.get().y * num;
    result.get().z = +vec.get().z * num;
  }; 
  ...
  function double3_toString () {
    return $T08().Format("({0}, {1}, {2})", $T00().$Box(this.x), $T00().$Box(this.y), $T00().$Box(this.z));
  }; 
  ...
  function double3_Transform$37 (/* ref */ vec, /* ref */ mat, /* ref */ result) {
    var double = new JSIL.BoxedVariable(new ($T02())());
    $T02().prototype._ctor.call(double.get().MemberwiseClone(), vec.get().x, vec.get().y, vec.get().z, 1);
    $S09().CallStatic($T02(), "Transform", null, /* ref */ double, /* ref */ mat, /* ref */ double);
  ...
  function double3_Transform$39 (/* ref */ vec, /* ref */ quat, /* ref */ result) {
    ...
    $S03().CallStatic($thisType, "Multiply", null, /* ref */ vec, (quat.get()).get_w(), /* ref */ double2);
    $thisType.Add(/* ref */ double, /* ref */ double2, /* ref */ double);
    $thisType.Cross(/* ref */ xyz, /* ref */ double, /* ref */ double);
    $S03().CallStatic($thisType, "Multiply", null, /* ref */ double, 2, /* ref */ double);
  ...
  function double3_TransformNormal$3B (/* ref */ norm, /* ref */ mat, /* ref */ result) {
    var double4x = new JSIL.BoxedVariable($T09().Invert(mat.get().MemberwiseClone()).MemberwiseClone());
    $thisType.TransformNormalInverse(/* ref */ norm, /* ref */ double4x, /* ref */ result);
  }; 

  function double3_TransformNormalInverse$3C (norm, invMat) {
    var result = new $thisType();
    result.x = +$thisType.Dot(norm, $S0B().Construct(invMat.Row0));
    result.y = +$thisType.Dot(norm, $S0B().Construct(invMat.Row1));
    result.z = +$thisType.Dot(norm, $S0B().Construct(invMat.Row2));
    return result;
  }; 
  ...
  function double3_TransformPerspective$3F (/* ref */ vec, /* ref */ mat, /* ref */ result) {
    var double = new JSIL.BoxedVariable(new ($T02())());
    $S0C().Call($T02().prototype, "_ctor", null, double.get().MemberwiseClone(), vec.get());
    $S09().CallStatic($T02(), "Transform", null, /* ref */ double, /* ref */ mat, /* ref */ double);
  ...
  function double3_TransformPosition$40 (pos, mat) {
    var result = new $thisType();
    result.x = +$thisType.Dot(pos, $S0B().Construct(mat.get_Column0())) + +mat.Row3.x;
    result.y = +$thisType.Dot(pos, $S0B().Construct(mat.get_Column1())) + +mat.Row3.y;
    result.z = +$thisType.Dot(pos, $S0B().Construct(mat.get_Column2())) + +mat.Row3.z;
    return result;
  }; 
  ...
  function double3_TransformVector$42 (vec, mat) {
    var result = new $thisType();
    result.x = +$thisType.Dot(vec, $S0B().Construct(mat.get_Column0()));
    result.y = +$thisType.Dot(vec, $S0B().Construct(mat.get_Column1()));
    result.z = +$thisType.Dot(vec, $S0B().Construct(mat.get_Column2()));
    return result;
  }; 
...
(function double4$Members () {
  ...
  function double4_NormalizeFast$25 () {
    var num = +$S05().CallStatic($T06(), "InverseSqrtFast", null, (((+this.x * +this.x) + (+this.y * +this.y)) + (+this.z * +this.z)) + (+this.w * +this.w));
    this.x = +this.x * num;
    this.y = +this.y * num;
    this.z = +this.z * num;
    this.w = +this.w * num;
  ...
  function double4_NormalizeFast$26 (vec) {
    var num = +$S05().CallStatic($T06(), "InverseSqrtFast", null, (((+vec.x * +vec.x) + (+vec.y * +vec.y)) + (+vec.z * +vec.z)) + (+vec.w * +vec.w));
    vec.x = +vec.x * num;
    vec.y = +vec.y * num;
    vec.z = +vec.z * num;
    vec.w = +vec.w * num;
  ...
  function double4_NormalizeFast$27 (/* ref */ vec, /* ref */ result) {
    var num = +$S05().CallStatic($T06(), "InverseSqrtFast", null, (((+vec.get().x * +vec.get().x) + (+vec.get().y * +vec.get().y)) + (+vec.get().z * +vec.get().z)) + (+vec.get().w * +vec.get().w));
    result.get().x = +vec.get().x * num;
    result.get().y = +vec.get().y * num;
    result.get().z = +vec.get().z * num;
    result.get().w = +vec.get().w * num;
  ...
  function double4_Transform$36 (/* ref */ vec, /* ref */ quat, /* ref */ result) {
    var quaternionD2 = new JSIL.BoxedVariable(new ($T0A())());
    var quaternionD = new JSIL.BoxedVariable(new ($T0A())());
    var quaternionD3 = new JSIL.BoxedVariable(new ($T0A())());
    $T0A().prototype._ctor.call(quaternionD.get().MemberwiseClone(), vec.get().x, vec.get().y, vec.get().z, vec.get().w);
    $T0A().Invert(/* ref */ quat, /* ref */ quaternionD2);
    $S0B().CallStatic($T0A(), "Multiply", null, /* ref */ quat, /* ref */ quaternionD, /* ref */ quaternionD3);
    $S0B().CallStatic($T0A(), "Multiply", null, /* ref */ quaternionD3, /* ref */ quaternionD2, /* ref */ quaternionD);
...
(function double4x4$Members () {
  ...
  function double4x4_CreatePerspectiveOffCenter$0C (left, right, bottom, top, zNear, zFar, /* ref */ result) {
    ...
    var m5 = +(((+zFar + +zNear) / (+zFar - +zNear)));
    var m6 = +((-((2 * +zFar) * +zNear) / (+zFar - +zNear)));
    result.set($S02().Construct(m, 0, m3, 0, 0, m2, m4, 0, 0, 0, m5, m6, 0, 0, 1, 0));
  }; 
  ...
  function double4x4_CreatePerspectiveOffCenter_ROW (left, right, bottom, top, zNear, zFar, /* ref */ result) {
    ...
    var m5 = +(((+zFar + +zNear) / (+zFar - +zNear)));
    var m6 = +((-((2 * +zFar) * +zNear) / (+zFar - +zNear)));
    result.set($S02().Construct(m, 0, 0, 0, 0, m2, 0, 0, m3, m4, m5, 1, 0, 0, m6, 0));
  }; 
  ...
  function double4x4_Invert$20 (mat) {
    ...
    if (flag) {
      ...
      if (isAffine) {
        ...
        var flag2 = (num29 > 1.1920930376163597E-07) || 
        (num29 < -1.1920930376163597E-07);
        if (flag2) {
          num29 = +((1 / num29));
  ...
  function double4x4_LookAt$21 (eye, target, up) {
    ...
    var double3 = $T02().Cross(double.MemberwiseClone(), double2.MemberwiseClone());
    return $S02().Construct(double2.x, double2.y, double2.z, -$T02().Dot(double2, eye), double3.x, double3.y, double3.z, -$T02().Dot(double3, eye), double.x, double.y, double.z, -$T02().Dot(double, eye), 0, 0, 0, 1);
  }; 
  ...
  function double4x4_LookAt_ROW$23 (eye, target, up) {
    ...
    var double2 = $T02().Normalize($T02().Cross(up.MemberwiseClone(), double.MemberwiseClone()).MemberwiseClone());
    var double3 = $T02().Cross(double.MemberwiseClone(), double2.MemberwiseClone());
    return $S00().Construct($S01().Construct(double2.x, double3.x, double.x, 0), $S01().Construct(double2.y, double3.y, double.y, 0), $S01().Construct(double2.z, double3.z, double.z, 0), $S01().Construct(-$T02().Dot(double2, eye), -$T02().Dot(double3, eye), -$T02().Dot(double, eye), 1));
  }; 
...
(function float2$Members () {
  ...
  function float2_GetBarycentric (a, b, c, point, /* ref */ u, /* ref */ v) {
    var float = $thisType.op_Subtraction(b.MemberwiseClone(), c);
    var float2 = $thisType.op_Subtraction(point.MemberwiseClone(), c);
    var float3 = $thisType.op_Subtraction(a.MemberwiseClone(), c);
    var num = (+float.y * +float3.x) - (+float.x * +float3.y);
    u.set(+((((+float.y * +float2.x) - (+float.x * +float2.y)) / num)));
    v.set(+((((+float3.x * +float2.y) - (+float3.y * +float2.x)) / num)));
  }; 
  ...
  function float2_IsTriangleCW (a, b, c) {
    var float = $thisType.op_Subtraction(b.MemberwiseClone(), c);
    var float2 = $thisType.op_Subtraction(a.MemberwiseClone(), c);
    var num = (+float2.x * +float.y) - (+float2.y * +float.x);
    return (num < 0);
  }; 
  ...
  function float2_NormalizeFast$24 () {
    var num = +$S05().CallStatic($T07(), "InverseSqrtFast", null, (+this.x * +this.x) + (+this.y * +this.y));
    this.x = +this.x * num;
    this.y = +this.y * num;
  }; 

  function float2_NormalizeFast$25 (vec) {
    var num = +$S05().CallStatic($T07(), "InverseSqrtFast", null, (+vec.x * +vec.x) + (+vec.y * +vec.y));
    vec.x = +vec.x * num;
    vec.y = +vec.y * num;
    return vec;
  }; 
  ...
  function float2_NormalizeFast$26 (/* ref */ vec, /* ref */ result) {
    var num = +$S05().CallStatic($T07(), "InverseSqrtFast", null, (+vec.get().x * +vec.get().x) + (+vec.get().y * +vec.get().y));
    result.get().x = +vec.get().x * num;
    result.get().y = +vec.get().y * num;
  }; 
  ...
  function float2_toString () {
    return $T09().Format("({0}, {1})", $T00().$Box(this.x), $T00().$Box(this.y));
  }; 
  ...
  function float2_Transform$34 (/* ref */ vec, /* ref */ quat, /* ref */ result) {
    var quaternion2 = new JSIL.BoxedVariable(new ($T0A())());
    var quaternion = new JSIL.BoxedVariable(new ($T0A())());
    var quaternion3 = new JSIL.BoxedVariable(new ($T0A())());
    $T0A().prototype._ctor.call(quaternion.get().MemberwiseClone(), vec.get().x, vec.get().y, 0, 0);
    $T0A().Invert(/* ref */ quat, /* ref */ quaternion2);
    $S07().CallStatic($T0A(), "Multiply", null, /* ref */ quat, /* ref */ quaternion, /* ref */ quaternion3);
    $S07().CallStatic($T0A(), "Multiply", null, /* ref */ quaternion3, /* ref */ quaternion2, /* ref */ quaternion);
...
(function float3$Members () {
  ...
  function float3_CalculateAngle$09 (first, second) {
    ...
    if (flag) {
      var num = +((+$thisType.Dot(first, second) / (+first.get_Length() * +second.get_Length())));
      var flag2 = num < -1;
      if (flag2) {
        num = -1;
      }
      ...
      var result = Math.fround(Math.acos(num));
    } else {
      result = 0;
    }
    return result;
  ...
  function float3_GetBarycentric (a, b, c, point, /* ref */ u, /* ref */ v) {
    ...
    var float2 = $thisType.op_Subtraction(a.MemberwiseClone(), c);
    var left = $thisType.op_Subtraction(point.MemberwiseClone(), c);
    var num = +$thisType.Dot(float, float);
    var num2 = +$thisType.Dot(float, float2);
    var num3 = +$thisType.Dot(float2, float2);
    var num4 = +$thisType.Dot(left, float);
    var num5 = +$thisType.Dot(left, float2);
    var num6 = (num * num3) - (num2 * num2);
    u.set(+((((num * num5) - (num2 * num4)) / num6)));
    v.set(+((((num3 * num4) - (num2 * num5)) / num6)));
  }; 
  ...
  function float3_NormalizeFast$29 () {
    var num = +$S05().CallStatic($T08(), "InverseSqrtFast", null, ((+this.x * +this.x) + (+this.y * +this.y)) + (+this.z * +this.z));
    this.x = +this.x * num;
    this.y = +this.y * num;
    this.z = +this.z * num;
  }; 
  ...
  function float3_NormalizeFast$2A (vec) {
    var num = +$S05().CallStatic($T08(), "InverseSqrtFast", null, ((+vec.x * +vec.x) + (+vec.y * +vec.y)) + (+vec.z * +vec.z));
    vec.x = +vec.x * num;
    vec.y = +vec.y * num;
    vec.z = +vec.z * num;
    return vec;
  ...
  function float3_NormalizeFast$2B (/* ref */ vec, /* ref */ result) {
    var num = +$S05().CallStatic($T08(), "InverseSqrtFast", null, ((+vec.get().x * +vec.get().x) + (+vec.get().y * +vec.get().y)) + (+vec.get().z * +vec.get().z));
    result.get().x = +vec.get().x * num;
    result.get().y = +vec.get().y * num;
    result.get().z = +vec.get().z * num;
  }; 
  ...
  function float3_toString () {
    return $T0B().Format("({0}, {1}, {2})", $T00().$Box(this.x), $T00().$Box(this.y), $T00().$Box(this.z));
  }; 

  function float3_Transform$38 (vec, mat) {
    var vector = $S0A().Construct(vec.x, vec.y, vec.z, 1);
    vector = $S0B().CallStatic($T0C(), "op_Multiply", null, mat, vector);
    return vector.get_xyz();
  }; 
  ...
  function float3_Transform$3A (/* ref */ vec, /* ref */ quat, /* ref */ result) {
    ...
    $S03().CallStatic($thisType, "Multiply", null, /* ref */ vec, (quat.get()).get_w(), /* ref */ float2);
    $thisType.Add(/* ref */ float, /* ref */ float2, /* ref */ float);
    $thisType.Cross(/* ref */ xyz, /* ref */ float, /* ref */ float);
    $S03().CallStatic($thisType, "Multiply", null, /* ref */ float, 2, /* ref */ float);
  ...
  function float3_TransformNormal$3C (/* ref */ norm, /* ref */ mat, /* ref */ result) {
    var float4x = new JSIL.BoxedVariable($T0C().Invert(mat.get().MemberwiseClone()).MemberwiseClone());
  ...
  function float3_TransformPerspective (mat) {
    var float = $S0D().Construct(this, 1);
    float = $S0B().CallStatic($T0C(), "op_Multiply", null, mat, float);
    var result = new $thisType();
    var flag = +float.w > 1.192093E-07;
    if (flag) {
...
(function float4$Members () {
  ...
  function float4_NormalizeFast$26 () {
    var num = +$S06().CallStatic($T0B(), "InverseSqrtFast", null, (((+this.x * +this.x) + (+this.y * +this.y)) + (+this.z * +this.z)) + (+this.w * +this.w));
    this.x = +this.x * num;
    this.y = +this.y * num;
    this.z = +this.z * num;
    this.w = +this.w * num;
  ...
  function float4_NormalizeFast$27 (vec) {
    var num = +$S06().CallStatic($T0B(), "InverseSqrtFast", null, (((+vec.x * +vec.x) + (+vec.y * +vec.y)) + (+vec.z * +vec.z)) + (+vec.w * +vec.w));
    vec.x = +vec.x * num;
    vec.y = +vec.y * num;
    vec.z = +vec.z * num;
    vec.w = +vec.w * num;
  ...
  function float4_NormalizeFast$28 (/* ref */ vec, /* ref */ result) {
    var num = +$S06().CallStatic($T0B(), "InverseSqrtFast", null, (((+vec.get().x * +vec.get().x) + (+vec.get().y * +vec.get().y)) + (+vec.get().z * +vec.get().z)) + (+vec.get().w * +vec.get().w));
    result.get().x = +vec.get().x * num;
    result.get().y = +vec.get().y * num;
    result.get().z = +vec.get().z * num;
    result.get().w = +vec.get().w * num;
  ...
  function float4_Transform (vec, $quat) {
    var quat = new JSIL.BoxedVariable($quat.MemberwiseClone());
    var quaternion2 = new JSIL.BoxedVariable(new ($T0D())());
    var quaternion = new JSIL.BoxedVariable(new ($T0D())());
    var quaternion3 = new JSIL.BoxedVariable(new ($T0D())());
    $T0D().prototype._ctor.call(quaternion.get().MemberwiseClone(), vec.x, vec.y, vec.z, vec.w);
    $T0D().Invert(/* ref */ quat, /* ref */ quaternion2);
    $S0C().CallStatic($T0D(), "Multiply", null, /* ref */ quat, /* ref */ quaternion, /* ref */ quaternion3);
    $S0C().CallStatic($T0D(), "Multiply", null, /* ref */ quaternion3, /* ref */ quaternion2, /* ref */ quaternion);
    return $S00().Construct((quaternion.get()).get_x(), (quaternion.get()).get_y(), (quaternion.get()).get_z(), (quaternion.get()).get_w());
  }; 

  function float4_TransformPerspective (mat) {
    var float = $S0D().CallStatic($T0E(), "op_Multiply", null, mat, this);
    return $thisType.op_Division(float.MemberwiseClone(), float.w);
  }; 
...
(function float4x4$Members () {
  ...
  function float4x4_LookAt$28 (eye, target, up) {
    ...
    var float3 = $T03().Cross(float.MemberwiseClone(), float2.MemberwiseClone());
    return $S02().Construct(float2.x, float2.y, float2.z, -$T03().Dot(float2, eye), float3.x, float3.y, float3.z, -$T03().Dot(float3, eye), float.x, float.y, float.z, -$T03().Dot(float, eye), 0, 0, 0, 1);
  }; 
  ...
  function float4x4_LookAt_ROW$2A (eye, target, up) {
    ...
    var float2 = $T03().Normalize($T03().Cross(up.MemberwiseClone(), float.MemberwiseClone()).MemberwiseClone());
    var float3 = $T03().Cross(float.MemberwiseClone(), float2.MemberwiseClone());
    return $S00().Construct($S01().Construct(float2.x, float3.x, float.x, 0), $S01().Construct(float2.y, float3.y, float.y, 0), $S01().Construct(float2.z, float3.z, float.z, 0), $S01().Construct(-$T03().Dot(float2, eye), -$T03().Dot(float3, eye), -$T03().Dot(float, eye), 1));
  }; 
...
(function M$Members () {
  ...
  var $S01 = function () {
    return ($S01 = JSIL.Memoize(new JSIL.MethodSignature($asm0F.System.Single, [
        $asm0F.System.Single, $asm0F.System.Single, 
        $asm0F.System.Single
      ]))) ();
  };
  ...
  function M_Lerp (a, b, blend) {
    blend = +$S01().CallStatic($thisType, "Clamp", null, blend, 0, 1);
  ...
  function M_NextPowerOfTwo$14 (n) {
    if ($T01().op_LessThan(n, $T01().Create(0, 0, 0))) {
      throw $S02().Construct("n", "Must be positive.");
    }
  ...
  function M_SineStep (t) {
    t = +$S01().CallStatic($thisType, "Clamp", null, t, 0, 1);
...
(function MinMaxRect$Members () {
  ...
  function MinMaxRect_FromCenterSize (center, size) {
    var float = $T00().op_Subtraction(center.MemberwiseClone(), $S00().CallStatic($T00(), "op_Multiply", null, 0.5, size.MemberwiseClone()));
    var result = new $thisType();
    result.Min = float.MemberwiseClone();
    result.Max = $T00().op_Addition(float.MemberwiseClone(), size);
    return result;
  }; 
  ...
  function MinMaxRect_toString () {
    return $T01().Format("Min: {0} Max: {1}", this.Min, this.Max);
  }; 
...
(function Quaternion$Members () {
  ...
  function Quaternion_EulerToQuaternion (e, inDegrees) {
    ...
    e.y = 6.28318548 - +e.y;
    var num = Math.fround(Math.sin(+e.y * 0.5));
    var num2 = Math.fround(Math.cos(+e.y * 0.5));
    var num3 = Math.fround(Math.sin(+e.x * 0.5));
    var num4 = Math.fround(Math.cos(+e.x * 0.5));
    var num5 = Math.fround(Math.sin(+e.z * 0.5));
    var num6 = Math.fround(Math.cos(+e.z * 0.5));
    return $S00().Construct((((num * num3) * num6) + ((num2 * num4) * num5)), (((num * num4) * num6) + ((num2 * num3) * num5)), (((num2 * num3) * num6) - ((num * num4) * num5)), (((num2 * num4) * num6) - ((num * num3) * num5)));
  }; 
  ...
  function Quaternion_FromAxisAngle (axis, angle) {
    ...
    if (flag) {
      ...
      var flag2 = +axis.get_LengthSquared() > 1;
      if (flag2) {
        result = $thisType.Identity.MemberwiseClone();
      } else {
  ...
  function Quaternion_FromToRotation (from, to) {
    var result = new $thisType();
    result.SetFromToRotation(from.MemberwiseClone(), to.MemberwiseClone());
    return result;
  }; 
  ...
  function Quaternion_Invert$09 (/* ref */ q, /* ref */ result) {
    ...
    var flag = lengthSquared > 1.192093E-07;
    if (flag) {
  ...
  function Quaternion_Normalize$10 () {
    ...
    if (!flag) {
      var num = +((1 / +this.get_Length()));
      (this.xyz = $S04().CallStatic($T00(), "op_Multiply", null, this.get_xyz().MemberwiseClone(), num));
      this.set_w(+this.get_w() * num);
    }
  }; 
  ...
  function Quaternion_QuaternionToEuler (q, inDegrees) {
    q.Normalize();
    var num = 2 * ((+q.get_x() * +q.get_y()) + (+q.get_z() * +q.get_w()));
    if ($S08().CallStatic($T05(), "Equals", null, num, 1)) {
      ...
      if ($S08().CallStatic($T05(), "Equals", null, num, -1)) {
        ...
        num3 = Math.fround(Math.atan2(2 * ((+q.get_y() * +q.get_w()) - (+q.get_x() * +q.get_z())), (1 - (2 * num6)) - (2 * num7)));
        num4 = Math.fround(Math.asin($S09().CallStatic($T05(), "Clamp", null, num, -1, 1)));
        num2 = Math.fround(Math.atan2(2 * ((+q.get_x() * +q.get_w()) - (+q.get_y() * +q.get_z())), (1 - (2 * num5)) - (2 * num7)));
      }
    }

    for (num3 = 6.28318548 - num3; num3 >= 6.28318548; num3 -= 6.28318548) {
    }

    for (; num3 <= -6.28318548; num3 += 6.28318548) {
    }
    if (inDegrees) {
    ...
    return $S01().Construct(num4, num3, num2);
  }; 
  ...
  function Quaternion_SetFromToRotation (from, to) {
    var xyz = $T00().Cross(from.MemberwiseClone(), to.MemberwiseClone());
    (this.xyz = xyz.MemberwiseClone());
    this.set_w(Math.fround((Math.sqrt(((Math.pow(from.get_Length(), 2)) * (Math.pow(to.get_Length(), 2))))) + $T00().Dot(from, to)));
    this.Normalize();
  }; 
  ...
  JSIL.MakeType({
    ...
    $.Method({Static:true , Public:true }, "FromToRotation", 
    ...
    $.Method({Static:false, Public:true }, "SetFromToRotation", 
      new JSIL.MethodSignature(null, [$asm0A.TypeRef("Fusee.Math.Core.float3"), $asm0A.TypeRef("Fusee.Math.Core.float3")]), 
...
(function QuaternionD$Members () {
  ...
  function QuaternionD_FromAxisAngle (axis, angle) {
    var flag = +axis.get_LengthSquared() < 1.1920930376163597E-07;
    if (flag) {
      var result = $thisType.Identity.MemberwiseClone();
    } else {
      var flag2 = +axis.get_LengthSquared() > 1;
  ...
  function QuaternionD_Invert$09 (/* ref */ q, /* ref */ result) {
    var lengthSquared = +(q.get()).get_LengthSquared();
    var flag = lengthSquared > 1.11022302462516E-16;
    if (flag) {
      var num = +((1 / lengthSquared));
  ...
  function QuaternionD_Normalize$10 () {
    ...
    if (!flag) {
      var num = +((1 / +this.get_Length()));
      (this.xyz = $S03().CallStatic($T00(), "op_Multiply", null, this.get_xyz().MemberwiseClone(), num));
      this.set_w(+this.get_w() * num);
    }
  }; 
    ...
    if (flag) {
      ...
      if (flag2) {
        ...
        if (flag3) {
          ...
          var flag5 = num < 0.99000000953674316;
          if (flag5) {
