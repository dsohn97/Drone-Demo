...
(function BclHelpers$Members () {
  ...
  var $T15 = function () {
    return ($T15 = JSIL.Memoize($asm11.ProtoBuf.WireType)) ();
  };
  var $T16 = function () {
    return ($T16 = JSIL.Memoize($asm11.ProtoBuf.TimeSpanScale)) ();
  };
  var $T17 = function () {
  ...
  function BclHelpers_ReadDateTime (source) {
    ...
    if ($T02().op_Equality(ticks, $T02().Create(0, 0, 32768))) {
      var result = $T00().MinValue.MemberwiseClone();
    } else {
      if ($T02().op_Equality(ticks, $T02().Create(16777215, 16777215, 32767))) {
  ...
  function BclHelpers_ReadDecimal (reader) {
    ...
    var flag = !$T04().op_Inequality(low, $T04().Create(0, 0, 0)) && 
    (high === 0);
    if (flag) {
      var result = $T08().Zero;
    } else {
      var lo = (($T04().op_BitwiseAnd(low, $T04().FromNumber(-1))).ToNumber(4294967295, true) | 0);
      var mid = (($T04().op_BitwiseAnd(
          $T04().op_RightShift(low, (32 >>> 0)), 
          $T04().FromNumber(-1)
        )).ToNumber(4294967295, true) | 0);
      var hi = (high | 0);
      var isNeg = (signScale & 1) === 1;
      var scale = ((signScale & 510) >>> (1 >>> 0) & 0xFF);
      result = $S01().Construct(lo, mid, hi, isNeg, scale);
    }
    return result;
  }; 
  ...
  function BclHelpers_ReadGuid (source) {
    ...
    var flag = !$T04().op_Inequality(low, $T04().Create(0, 0, 0)) && 
    $T04().op_Equality(high, $T04().Create(0, 0, 0));
    if (flag) {
      var result = $T0A().Empty.MemberwiseClone();
    } else {
      var a = (($T04().op_RightShift(low, (32 >>> 0))).ToNumber(4294967295, false) >>> 0);
      var b = (low.ToNumber(4294967295, false) >>> 0);
      var c = (($T04().op_RightShift(high, (32 >>> 0))).ToNumber(4294967295, false) >>> 0);
      var d = (high.ToNumber(4294967295, false) >>> 0);
      result = $S02().Construct((b | 0), ((a + 0x8000 & 0xFFFF) - 0x8000), ((a >>> (16 >>> 0) + 0x8000 & 0xFFFF) - 0x8000), (d & 0xFF), (d >>> (8 >>> 0) & 0xFF), (d >>> (16 >>> 0) & 0xFF), (d >>> (24 >>> 0) & 0xFF), (c & 0xFF), (c >>> (8 >>> 0) & 0xFF), (c >>> (16 >>> 0) & 0xFF), (c >>> (24 >>> 0) & 0xFF));
    }
    return result;
  }; 
          ...
          case 0: /* $entry0 */ 
            switch (fieldNumber) {
              ...
              case 3: 
                ...
                type.set($T0D().$Cast((source.get_NetCache()).GetKeyedObject(tmp)));
              ...
              case 8: 
                ...
                if (flag) {
                  throw $S03().Construct(("Unable to resolve type: " + typeName + " (you can use the TypeModel.DynamicTypeFormatting event to provide a custom mapping)"));
                }
              ...
              case 10: 
                var isString = type.get() === $T10().__Type__;
                ...
                if (flag7) {
                  ...
                  value = $T01().ReadTypedObject(oldValue, key, source, type.get());
                }
  ...
  function BclHelpers_ReadTimeSpan (source) {
    ...
    if ($T02().op_Equality(ticks, $T02().Create(0, 0, 32768))) {
      ...
      if ($T02().op_Equality(ticks, $T02().Create(16777215, 16777215, 32767))) {
        ...
        result = $T14().FromTicks(ticks).MemberwiseClone();
      }
    }
    return result;
  }; 
    ...
    if (wireType !== $T15().Fixed64) {
      ...
      while ((fieldNumber = (source.ReadFieldHeader() | 0)) > 0) {
        ...
        if (num !== 1) {
          ...
          source.Assert($T15().SignedVariant);
      ...
      switch (timeSpanScale.valueOf()) {
        case 0: 
          var result = $T02().op_Multiplication(value, $T02().Create(6930432, 51498, 0));
          break;

        case 1: 
          result = $T02().op_Multiplication(value, $T02().Create(12871680, 2145, 0));
          break;

        case 2: 
          result = $T02().op_Multiplication(value, $T02().Create(12797440, 35, 0));
          break;

        case 3: 
          result = $T02().op_Multiplication(value, $T02().Create(10000000, 0, 0));
          break;

        case 4: 
          result = $T02().op_Multiplication(value, $T02().Create(10000, 0, 0));
          break;
        ...
        default: 
          if (timeSpanScale !== $T16().MinMax) {
            throw $S03().Construct(JSIL.ConcatString("Unknown timescale: ", scale.toString()));
          }
          var num2 = value;
          if (!$T02().op_Equality(num2, $T02().Create(16777215, 16777215, 65535))) {
            if (!$T02().op_Equality(num2, $T02().Create(1, 0, 0))) {
              throw $S03().Construct(JSIL.ConcatString("Unknown min/max value: ", (value).toString()));
            }
  ...
  function BclHelpers_WriteDateTime (value, dest) {
    ...
    if ((((wireType - $T15().String) | 0) >>> 0) > (1 >>> 0)) {
      var delta = $S06().CallStatic($T00(), "op_Subtraction", null, value, $thisType.EpochOrigin).MemberwiseClone();
    } else {
      var flag2 = $T00().op_Equality(value.MemberwiseClone(), $T00().MaxValue.MemberwiseClone());
      if (flag2) {
        delta = $T14().MaxValue.MemberwiseClone();
      } else {
        var flag3 = $T00().op_Equality(value.MemberwiseClone(), $T00().MinValue.MemberwiseClone());
        if (flag3) {
          delta = $T14().MinValue.MemberwiseClone();
        } else {
          delta = $S06().CallStatic($T00(), "op_Subtraction", null, value, $thisType.EpochOrigin).MemberwiseClone();
        }
      }
    }
  ...
  function BclHelpers_WriteDecimal (value, writer) {
    ...
    var a = $T04().op_LeftShift(($T02().FromNumber(bits[1])).ToUInt64(), 32);
    var b = ($T02().op_BitwiseAnd(
        $T02().FromNumber(bits[0]), 
        ($T04().FromNumber(-1)).ToInt64()
      )).ToUInt64();
    var low = $T04().op_BitwiseOr(a, b);
    var high = (bits[2] >>> 0);
    var signScale = ((((bits[3] | 0) >> 15) & 510) | (((bits[3] | 0) >> 31) & 1) >>> 0);
    var token = $T17().StartSubItem(null, writer);
    if ($T04().op_GreaterThan(low, $T04().Create(0, 0, 0))) {
      $T17().WriteFieldHeader(1, $T15().Variant, writer);
      $T17().WriteUInt64(low, writer);
    }
    if (high > 0) {
      $T17().WriteFieldHeader(2, $T15().Variant, writer);
      $T17().WriteUInt32(high, writer);
    }
    if (signScale > 0) {
      $T17().WriteFieldHeader(3, $T15().Variant, writer);
      $T17().WriteUInt32(signScale, writer);
    }
  ...
  function BclHelpers_WriteGuid (value, dest) {
    ...
    if (flag) {
      $T17().WriteFieldHeader(1, $T15().Fixed64, dest);
      $T17().WriteBytes(blob, 0, 8, dest);
      $T17().WriteFieldHeader(2, $T15().Fixed64, dest);
      $T17().WriteBytes(blob, 8, 8, dest);
    }
  ...
  function BclHelpers_WriteNetObject (value, dest, key, options) {
    ...
    var dynamicType = $T0E().$Cast(options & $T0E().DynamicType) > $T0E().None;
    var asReference = $T0E().$Cast(options & $T0E().AsReference) > $T0E().None;
    var wireType = dest.get_WireType();
    var token = $T17().StartSubItem(null, dest);
    ...
    if (flag4) {
      var flag5 = dynamicType;
      if (flag5) {
        type.set(JSIL.GetType(value));
        var flag6 = !$T10().$Is(value);
        if (flag6) {
  ...
  function BclHelpers_WriteTimeSpan (timeSpan, dest) {
    ...
    if (wireType !== $T15().Fixed64) {
      ...
      if (flag2) {
        value = $T02().Create(1, 0, 0);
        var scale = $T16().MinMax;
      } else {
        var flag3 = $T14().op_Equality(timeSpan.MemberwiseClone(), $T14().MinValue.MemberwiseClone());
        if (flag3) {
          value = $T02().Create(16777215, 16777215, 65535);
          scale = $T16().MinMax;
        } else {
          var flag4 = $T02().op_Equality(
            $T02().op_Modulus(value, $T02().Create(6930432, 51498, 0)), 
            $T02().Create(0, 0, 0)
          );
          if (flag4) {
            scale = $T16().Days;
            value = $T02().op_Division(value, $T02().Create(6930432, 51498, 0));
          } else {
            var flag5 = $T02().op_Equality(
              $T02().op_Modulus(value, $T02().Create(12871680, 2145, 0)), 
              $T02().Create(0, 0, 0)
            );
            if (flag5) {
              scale = $T16().Hours;
              value = $T02().op_Division(value, $T02().Create(12871680, 2145, 0));
            } else {
              var flag6 = $T02().op_Equality(
                $T02().op_Modulus(value, $T02().Create(12797440, 35, 0)), 
                $T02().Create(0, 0, 0)
              );
              if (flag6) {
                scale = $T16().Minutes;
                value = $T02().op_Division(value, $T02().Create(12797440, 35, 0));
              } else {
                var flag7 = $T02().op_Equality(
                  $T02().op_Modulus(value, $T02().Create(10000000, 0, 0)), 
                  $T02().Create(0, 0, 0)
                );
                if (flag7) {
                  scale = $T16().Seconds;
                  value = $T02().op_Division(value, $T02().Create(10000000, 0, 0));
                } else {
                  var flag8 = $T02().op_Equality(
                    $T02().op_Modulus(value, $T02().Create(10000, 0, 0)), 
                    $T02().Create(0, 0, 0)
                  );
                  if (flag8) {
                    scale = $T16().Milliseconds;
                    value = $T02().op_Division(value, $T02().Create(10000, 0, 0));
                  } else {
                    scale = $T16().Ticks;
                  }
                }
      ...
      if (flag9) {
        $T17().WriteFieldHeader(1, $T15().SignedVariant, dest);
        $T17().WriteInt64(value, dest);
      }
      var flag10 = scale > $T16().Days;
      if (flag10) {
        $T17().WriteFieldHeader(2, $T15().Variant, dest);
        $T17().WriteInt32(scale.valueOf(), dest);
      }
      $T17().EndSubItem(token, dest);
    } else {
...
(function ProtoReader$Members () {
  ...
  function ProtoReader_ReadFieldHeader () {
    ...
    if (((this.blockEnd | 0) <= (this.position | 0)) || (this.wireType === $T0A().EndGroup)) {
      ...
      if (flag2) {
        ...
        this.fieldNumber = ((tag.get() >>> 0) >>> (3 >>> 0) | 0);
  ...
  function ProtoReader_ReadSingle () {
    ...
    if (wireType !== $T0A().Fixed64) {
      ...
      var flag = $S10().CallStatic($T0B(), "IsInfinity", null, f) && 
      !$S11().CallStatic($T0B(), "IsInfinity", null, value2);
      if (flag) {
  ...
  function ProtoReader_ReadUInt32 () {
    ...
    if ((wireType.valueOf() | 0) !== 0) {
      if (wireType !== $T0A().Fixed64) {
        ...
        result = ($T0C().$OverflowCheck(val.ToNumber(4294967295, false)) >>> 0);
      }
    } else {
  ...
  function ProtoReader_ReadUInt64Variant () {
    var value = new JSIL.BoxedVariable($T24().Create(0, 0, 0));
  ...
  function ProtoReader_TryReadFieldHeader (field) {
    var tag = new JSIL.BoxedVariable(0);
    var tmpWireType = $asm11.ProtoBuf.WireType.Variant;
    if (((this.blockEnd | 0) <= (this.position | 0)) || (this.wireType === $T0A().EndGroup)) {
      var result = false;
    } else {
  ...
  function ProtoReader_TryReadUInt32VariantWithoutMoving (trimNegative, /* ref */ value) {
    ...
    if ((this.available | 0) === 0) {
      ...
      value.set(this.ioBuffer[($temp00 = readPos, 
          readPos = ((readPos + 1) | 0), 
          $temp00)]);
      ...
      if (flag3) {
        ...
        var chunk = (this.ioBuffer[($temp01 = readPos, 
          readPos = ((readPos + 1) | 0), 
          $temp01)] | 0);
        ...
        if (flag5) {
          ...
          chunk = (this.ioBuffer[($temp02 = readPos, 
            readPos = ((readPos + 1) | 0), 
            $temp02)] | 0);
          ...
          if (flag7) {
            ...
            chunk = (this.ioBuffer[($temp03 = readPos, 
              readPos = ((readPos + 1) | 0), 
              $temp03)] | 0);
            ...
            if (flag9) {
              ...
              if (flag11) {
                ...
                var flag12 = !(!trimNegative || 
                  ((chunk & 240) !== 240) || 
                  ((this.available | 0) < 10) || 
                  ((this.ioBuffer[(readPos = ((readPos + 1) | 0))] | 0) !== 255) || 
                  ((this.ioBuffer[(readPos = ((readPos + 1) | 0))] | 0) !== 255) || 
                  ((this.ioBuffer[(readPos = ((readPos + 1) | 0))] | 0) !== 255) || 
                  ((this.ioBuffer[(readPos = ((readPos + 1) | 0))] | 0) !== 255)) && 
                ((this.ioBuffer[((readPos + 1) | 0)] | 0) === 1);
                if (!flag12) {
                  throw $thisType.AddErrorData($S12().Construct(), this);
                }
                result = 10;
  ...
  function ProtoReader_TryReadUInt64VariantWithoutMoving (/* ref */ value) {
    ...
    if ((this.available | 0) === 0) {
      ...
      var readPos = (this.ioIndex | 0);
      value.set($T24().FromNumber(this.ioBuffer[($temp00 = readPos, 
            readPos = ((readPos + 1) | 0), 
            $temp00)]));
      ...
      if (flag3) {
        ...
        var chunk = $T24().FromNumber(this.ioBuffer[($temp01 = readPos, 
            readPos = ((readPos + 1) | 0), 
            $temp01)]);
        value.set($T24().op_BitwiseOr(
            value.get(), 
            $T24().op_LeftShift($T24().op_BitwiseAnd(chunk, $T24().Create(127, 0, 0)), 7)
          ));
        var flag5 = $T24().op_Equality(
          $T24().op_BitwiseAnd(chunk, $T24().Create(128, 0, 0)), 
          $T24().Create(0, 0, 0)
        );
        if (flag5) {
          result = 2;
          ...
          chunk = $T24().FromNumber(this.ioBuffer[($temp02 = readPos, 
              readPos = ((readPos + 1) | 0), 
              $temp02)]);
          value.set($T24().op_BitwiseOr(
              value.get(), 
              $T24().op_LeftShift($T24().op_BitwiseAnd(chunk, $T24().Create(127, 0, 0)), 14)
            ));
          ...
          if (flag7) {
            ...
            chunk = $T24().FromNumber(this.ioBuffer[($temp03 = readPos, 
                readPos = ((readPos + 1) | 0), 
                $temp03)]);
            value.set($T24().op_BitwiseOr(
                value.get(), 
                $T24().op_LeftShift($T24().op_BitwiseAnd(chunk, $T24().Create(127, 0, 0)), 21)
              ));
            ...
            if (flag9) {
              ...
              chunk = $T24().FromNumber(this.ioBuffer[($temp04 = readPos, 
                  readPos = ((readPos + 1) | 0), 
                  $temp04)]);
              value.set($T24().op_BitwiseOr(
                  value.get(), 
                  $T24().op_LeftShift($T24().op_BitwiseAnd(chunk, $T24().Create(127, 0, 0)), 28)
                ));
              ...
              if (flag11) {
                ...
                chunk = $T24().FromNumber(this.ioBuffer[($temp05 = readPos, 
                    readPos = ((readPos + 1) | 0), 
                    $temp05)]);
                value.set($T24().op_BitwiseOr(
                    value.get(), 
                    $T24().op_LeftShift($T24().op_BitwiseAnd(chunk, $T24().Create(127, 0, 0)), 35)
                  ));
                ...
                if (flag13) {
                  ...
                  chunk = $T24().FromNumber(this.ioBuffer[($temp06 = readPos, 
                      readPos = ((readPos + 1) | 0), 
                      $temp06)]);
                  value.set($T24().op_BitwiseOr(
                      value.get(), 
                      $T24().op_LeftShift($T24().op_BitwiseAnd(chunk, $T24().Create(127, 0, 0)), 42)
                    ));
                  ...
                  if (flag15) {
                    ...
                    chunk = $T24().FromNumber(this.ioBuffer[($temp07 = readPos, 
                        readPos = ((readPos + 1) | 0), 
                        $temp07)]);
                    value.set($T24().op_BitwiseOr(
                        value.get(), 
                        $T24().op_LeftShift($T24().op_BitwiseAnd(chunk, $T24().Create(127, 0, 0)), 49)
                      ));
                    ...
                    if (flag17) {
                      ...
                      chunk = $T24().FromNumber(this.ioBuffer[($temp08 = readPos, 
                          readPos = ((readPos + 1) | 0), 
                          $temp08)]);
                      value.set($T24().op_BitwiseOr(
                          value.get(), 
                          $T24().op_LeftShift($T24().op_BitwiseAnd(chunk, $T24().Create(127, 0, 0)), 56)
                        ));
                      ...
                      if (flag19) {
                        ...
                        chunk = $T24().FromNumber(this.ioBuffer[readPos]);
                        value.set($T24().op_BitwiseOr(
                            value.get(), 
                            $T24().op_LeftShift(chunk, 63)
                          ));
                        var flag21 = $T24().op_GreaterThan(
                          $T24().op_BitwiseAnd(chunk, $T24().Create(16777214, 16777215, 65535)), 
                          $T24().Create(0, 0, 0)
                        );
                        if (flag21) {
                          throw $thisType.AddErrorData($S12().Construct(), this);
...
(function ProtoWriter$Members () {
  ...
  function ProtoWriter_CheckRecursionStackAndPush (instance) {
    ...
    if (this.recursionStack === null) {
      ...
      if (flag2) {
        ...
        throw $S03().Construct(("Possible recursion detected (offset: " + (((((this.recursionStack).get_Count() | 0) - hitLevel) | 0)).toString() + " level(s)): " + instance.toString()));
      }
    }
  ...
  function ProtoWriter_ThrowEnumException (writer, enumValue) {
    ...
    ;
    throw $S03().Construct(("No wire-value is mapped to the enum " + rhs + " at position " + (writer.position).toString()));
  }; 
  ...
  function ProtoWriter_WriteDouble (value, writer) {
    ...
    if (wireType !== $T09().Fixed64) {
      ...
      var flag2 = $S07().CallStatic($T0E(), "IsInfinity", null, f) && 
      ...
      case 8: 
        ...
        if (flag4) {
          ...
          if (!((wireType2 <= $T09().Fixed64) || 
              (wireType2 === $T09().Fixed32) || (wireType2 === $T09().SignedVariant))) {
    ...
    if (wireType <= $T09().Fixed64) {
      if ((wireType.valueOf() | 0) === 0) {
        if ($T20().op_GreaterThanOrEqual(value, $T20().Create(0, 0, 0))) {
          ...
          var buffer = writer.ioBuffer;
          var index = (writer.ioIndex | 0);
          buffer[index] = (($T20().op_BitwiseOr(value, $T20().Create(128, 0, 0))).ToNumber(255, false) | 0);
          buffer[((index + 1) | 0)] = ((($T20().op_RightShift(value, 7)).ToNumber(4294967295, true) | 0) | 128 & 0xFF);
          buffer[((index + 2) | 0)] = ((($T20().op_RightShift(value, 14)).ToNumber(4294967295, true) | 0) | 128 & 0xFF);
          buffer[((index + 3) | 0)] = ((($T20().op_RightShift(value, 21)).ToNumber(4294967295, true) | 0) | 128 & 0xFF);
          buffer[((index + 4) | 0)] = ((($T20().op_RightShift(value, 28)).ToNumber(4294967295, true) | 0) | 128 & 0xFF);
          buffer[((index + 5) | 0)] = ((($T20().op_RightShift(value, 35)).ToNumber(4294967295, true) | 0) | 128 & 0xFF);
          buffer[((index + 6) | 0)] = ((($T20().op_RightShift(value, 42)).ToNumber(4294967295, true) | 0) | 128 & 0xFF);
          buffer[((index + 7) | 0)] = ((($T20().op_RightShift(value, 49)).ToNumber(4294967295, true) | 0) | 128 & 0xFF);
          buffer[((index + 8) | 0)] = ((($T20().op_RightShift(value, 56)).ToNumber(4294967295, true) | 0) | 128 & 0xFF);
          buffer[((index + 9) | 0)] = 1;
          $thisType.IncrementedAndReset(10, writer);
        }
        return;
      ...
      if (wireType === $T09().Fixed64) {
        ...
        buffer[((index + 1) | 0)] = (($T20().op_RightShift(value, 8)).ToNumber(255, false) | 0);
        buffer[((index + 2) | 0)] = (($T20().op_RightShift(value, 16)).ToNumber(255, false) | 0);
        buffer[((index + 3) | 0)] = (($T20().op_RightShift(value, 24)).ToNumber(255, false) | 0);
        buffer[((index + 4) | 0)] = (($T20().op_RightShift(value, 32)).ToNumber(255, false) | 0);
        buffer[((index + 5) | 0)] = (($T20().op_RightShift(value, 40)).ToNumber(255, false) | 0);
        buffer[((index + 6) | 0)] = (($T20().op_RightShift(value, 48)).ToNumber(255, false) | 0);
        buffer[((index + 7) | 0)] = (($T20().op_RightShift(value, 56)).ToNumber(255, false) | 0);
        $thisType.IncrementedAndReset(8, writer);
        return;
      }
    } else {
  ...
  function ProtoWriter_WriteString (value, writer) {
    ...
    if (flag4) {
      ...
      $T0E().DebugAssert(predicted === actual);
  ...
  function ProtoWriter_WriteUInt32Variant (value, writer) {
    ...
    do {
      ...
      writer.ioIndex = ((num + 1) | 0);
      arg_2E_0[num] = (((value >>> 0) & 127) | 128 & 0xFF);
      count = ((count + 1) | 0);
...
(function Node$Members () {
  ...
  function Node_Append (value) {
    ...
    if (this.data === null) {
      var newData = JSIL.Array.New($T03(), 10);
    } else {
      var flag2 = (this.$length | 0) === (this.data.length | 0);
      if (flag2) {
        newData = JSIL.Array.New($T03(), Math.imul(this.data.length, 2));
        $S00().CallStatic($T05(), "Copy", null, this.data, newData, this.$length);
      } else {
        newData = this.data;
      }
    }
...
(function TypeModel$Members () {
  ...
  var $T22 = function () {
    return ($T22 = JSIL.Memoize($asm0F.System.UInt32)) ();
  };
  var $T23 = function () {
    return ($T23 = JSIL.Memoize($asm0F.System.ArgumentNullException)) ();
  };
  var $T24 = function () {
    return ($T24 = JSIL.Memoize($asm0F.System.Collections.Generic.IEnumerable$b1)) ();
  };
  var $T25 = function () {
    return ($T25 = JSIL.Memoize($asm0F.System.Collections.Generic.ICollection$b1)) ();
  };
  var $T26 = function () {
    return ($T26 = JSIL.Memoize($asm11.ProtoBuf.ProtoWriter)) ();
  };
  var $T27 = function () {
    return ($T27 = JSIL.Memoize($asm0F.System.IDisposable)) ();
  };
  var $T28 = function () {
    return ($T28 = JSIL.Memoize($asm0F.System.InvalidOperationException)) ();
  };
  var $T29 = function () {
    return ($T29 = JSIL.Memoize(System.Array.Of($asm0F.System.Byte))) ();
  };
  var $T2A = function () {
    return ($T2A = JSIL.Memoize($asm11.ProtoBuf.SubItemToken)) ();
  };
  var $T2B = function () {
    return ($T2B = JSIL.Memoize($asm0F.System.Char)) ();
  };
  var $T2C = function () {
    return ($T2C = JSIL.Memoize($asm0F.System.SByte)) ();
  };
  var $T2D = function () {
    return ($T2D = JSIL.Memoize($asm0F.System.Byte)) ();
  };
  var $T2E = function () {
    return ($T2E = JSIL.Memoize($asm0F.System.Int16)) ();
  };
  var $T2F = function () {
    return ($T2F = JSIL.Memoize($asm0F.System.UInt16)) ();
  };
  var $T30 = function () {
      ...
      if (flag) {
        ...
        if (flag2) {
          ...
          if (flag3) {
            ...
            concreteListType = $T0B().__Type__.MakeGenericType(genericTypes);
            handled = true;
          }
        }
        var flag4 = !handled;
        if (flag4) {
          concreteListType = $T0C().__Type__.MakeGenericType(JSIL.Array.New($T01(), [itemType]));
        }
      }
      result = $S00().CallStatic($T0D(), "CreateInstance", null, concreteListType);
    }
    return result;
  }; 
  ...
  function TypeModel_Deserialize$01 (source, value, $type, context) {
    ...
    var reader = null;
    try {
      reader = $T11().Create(source, this, context, -1);
      if (value !== null) {
    ...
    if (flag) {
      ...
      for (var k = 0; k < (properties.length | 0); k = ((k + 1) | 0)) {
        ...
        if (!flag5) {
          ...
          ((args[0]).get_ParameterType() !== model.MapType($T07().__Type__));
          if (!flag6) {
      ...
      switch (candidates.get_Count()) {
        ...
        case 1: 
          result = $T01().$Cast(candidates.get_Item(0));
          return result;

        case 2: 
          var flag7 = $thisType.CheckDictionaryAccessors(
            model, 
            $T01().$Cast(candidates.get_Item(0)), 
            $T01().$Cast(candidates.get_Item(1))
          );
          if (flag7) {
            result = $T01().$Cast(candidates.get_Item(0));
            return result;
          ...
          if (flag8) {
            result = $T01().$Cast(candidates.get_Item(1));
            return result;
          }
          break;
  ...
  function TypeModel_ResolveListAdd (model, listType, itemType, /* ref */ isList) {
    ...
    var types = JSIL.Array.New($T01(), [itemType]);
    var add = $T08().GetInstanceMethod(listType, "Add", types);
    var flag = add === null;
    if (flag) {
      var forceList = listType.get_IsInterface() && 
      (listType === (model.MapType($T24().__Type__)).MakeGenericType(types));
      var constuctedListType = (model.MapType($T25().__Type__)).MakeGenericType(types);
      var flag2 = forceList || 
      $S05().CallVirtual("IsAssignableFrom", null, constuctedListType, listType);
      if (flag2) {
        add = $T08().GetInstanceMethod(constuctedListType, "Add", types);
      }
    }
    var flag3 = add === null;
    if (flag3) {
    ...
    $loop0: 
      for (var i = 0; i < (interfaces.length | 0); i = ((i + 1) | 0)) {
        ...
        if (flag4) {
          add = $T08().GetInstanceMethod(interfaceType, "TryAdd", types);
          var flag5 = add !== null;
          if (flag5) {
            break $loop0;
          }
    ...
    var flag6 = add === null;
    if (flag6) {
      types[0] = model.MapType($T05().__Type__);
      add = $T08().GetInstanceMethod(listType, "Add", types);
    }
    var flag7 = (add === null) & isList.get();
    if (flag7) {
      add = $T08().GetInstanceMethod(model.MapType($thisType.ilist), "Add", types);
    }
    return add;
  }; 
  ...
  function TypeModel_ResolveProxies (type) {
    ...
    if (flag) {
      ...
      if (isGenericParameter) {
        ...
        var tmp = $T08().GetUnderlyingType(type);
        if (tmp !== null) {
          result = tmp;
        } else {
  ...
  function TypeModel_Serialize$06 (dest, value, context) {
    var writer = new ($T26())(dest, this, context);
    try {
  ...
  function TypeModel_SerializeType (model, type) {
    ...
    if (flag) {
      ...
      var flag2 = handler !== null;
      if (flag2) {
        var args = $S09().Construct(type);
        handler(model, args);
        var flag3 = !$T08().IsNullOrEmpty(args.get_FormattedName());
        if (flag3) {
  ...
  function TypeModel_TestEnumerableListPatterns (model, candidates, iType) {
    ...
    if (isGenericType) {
      ...
      var flag = (typeDef === model.MapType($T24().__Type__)) || 
      (typeDef === model.MapType($T25().__Type__)) || 
  ...
  function TypeModel_ThrowUnexpectedType (type) {
    ...
    if (flag) {
      ...
      if (flag2) {
        throw $S0A().Construct(JSIL.ConcatString("Are you mixing protobuf-net and protobuf-csharp-port? See http://stackoverflow.com/q/11564914; type: ", fullName));
      }
    }
    throw $S0A().Construct(JSIL.ConcatString("Type is not expected, and no contract can be inferred: ", fullName));
  }; 
  ...
  $labelgroup0: 
    while (true) {
      switch ($label0) {
        ...
        $loop0: 
          while (true) {
            ...
            if (fieldNumber !== (tag | 0)) {
              ...
              if (flag9) {
                if ((((wiretype - $T21().String) | 0) >>> 0) > (1 >>> 0)) {
                  value.set($S03().CallVirtual("Deserialize", null, this, modelKey.get(), value.get(), reader));
                } else {
                ...
                switch (protoTypeCode.valueOf()) {
                  ...
                  case 4: 
                    value.set($T2B().$Box(String.fromCharCode(reader.ReadUInt16())));
                    break;

                  case 5: 
                    value.set($T2C().$Box(reader.ReadSByte()));
                    break;

                  case 6: 
                    value.set($T2D().$Box(reader.ReadByte()));
                    break;

                  case 7: 
                    value.set($T2E().$Box(reader.ReadInt16()));
                    break;

                  case 8: 
                    value.set($T2F().$Box(reader.ReadUInt16()));
                    break;
                  ...
                  case 10: 
                    value.set($T22().$Box(reader.ReadUInt32()));
                    break;
                  ...
                  default: 
                    switch (protoTypeCode.valueOf()) {
                      ...
                      case 101: 
                        value.set($T11().AppendBytes($T29().$Cast(value.get()), reader));
                        break;
        ...
        case 1: /* IL_12E */ 
          throw $T11().AddErrorData($S0A().Construct(("Expected field " + (tag).toString() + ", but found " + (fieldNumber).toString())), reader);
          break $labelgroup0;

      }
    }
    /* Original label IL_375 */ 
    var flag10 = (!found && 
      !asListItem) & autoCreate;
    if (flag10) {
      var flag11 = type.get() !== $T03().__Type__;
      if (flag11) {
  ...
  function TypeModel_TryDeserializeList (model, reader, format, tag, listType, itemType, /* ref */ value) {
    ...
    if (flag5) {
      ...
      if (flag6) {
        ...
        if (!flag7) {
          var existing = $T06().$Cast(value.get());
          var newArray = (JSIL.Array.New(itemType, (((existing.length | 0) + (arraySurrogate.get_Count() | 0)) | 0)));
          $S0C().CallStatic($T06(), "Copy", null, existing, newArray, existing.length);
  ...
  function TypeModel_TrySerializeAuxiliaryType (writer, $type, format, tag, value, isInsideList) {
    ...
    if (flag2) {
      ...
      if (flag3) {
        $S08().CallVirtual("Serialize", null, this, modelKey.get(), value, writer);
        var result = true;
      } else {
        $T26().WriteFieldHeader(tag, wireType, writer);
        var wireType2 = wireType;
        if (wireType2 === $T21().None) {
          throw $T26().CreateException(writer);
        }
        if ((((wireType2 - $T21().String) | 0) >>> 0) > (1 >>> 0)) {
          $S08().CallVirtual("Serialize", null, this, modelKey.get(), value, writer);
          result = true;
        } else {
          var token = $T26().StartSubItem(value, writer);
          $S08().CallVirtual("Serialize", null, this, modelKey.get(), value, writer);
          $T26().EndSubItem(token, writer);
          result = true;
        }
      }
    } else {
      ...
      switch (protoTypeCode.valueOf()) {
        case 3: 
          $T26().WriteBoolean($T04().$Cast(value), writer);
          result = true;
          return result;

        case 4: 
          $T26().WriteUInt16(($T2B().$Cast(value)).charCodeAt(0), writer);
          result = true;
          return result;

        case 5: 
          $T26().WriteSByte($T2C().$Cast(value), writer);
          result = true;
          return result;

        case 6: 
          $T26().WriteByte($T2D().$Cast(value), writer);
          result = true;
          return result;

        case 7: 
          $T26().WriteInt16($T2E().$Cast(value), writer);
          result = true;
          return result;

        case 8: 
          $T26().WriteUInt16($T2F().$Cast(value), writer);
          result = true;
          return result;

        case 9: 
          $T26().WriteInt32($T07().$Cast(value), writer);
          result = true;
          return result;

        case 10: 
          $T26().WriteUInt32($T22().$Cast(value), writer);
          result = true;
          return result;

        case 11: 
          $T26().WriteInt64($T35().$Cast(value), writer);
          result = true;
          return result;

        case 12: 
          $T26().WriteUInt64($T36().$Cast(value), writer);
          result = true;
          return result;

        case 13: 
          $T26().WriteSingle($T30().$Cast(value), writer);
          result = true;
          return result;

        case 14: 
          $T26().WriteDouble($T31().$Cast(value), writer);
          result = true;
          return result;
        ...
        case 18: 
          $T26().WriteString($T03().$Cast(value), writer);
          result = true;
          return result;
        ...
        default: 
          switch (protoTypeCode.valueOf()) {
            ...
            case 101: 
              $T26().WriteBytes($T29().$Cast(value), writer);
              result = true;
              return result;
            ...
            case 103: 
              $T26().WriteString(($T33().$Cast(value)).get_AbsoluteUri(), writer);
              result = true;
              return result;
      ...
      if (flag5) {
        ...
        try {
          ...
          var disposable = $T27().$As(enumerator);
          if (disposable !== null) {
