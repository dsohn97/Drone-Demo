...
JSIL.SetEntryPoint($asm08, $asm08.TypeRef("Fusee.Engine.Player.Web.Player"), "Main", JSIL.MethodSignature.Void);
...
/* class Fusee.Engine.Player.Web.Player */ 
...
(function Player$Members () {
  ...
  var $T07 = function () {
    return ($T07 = JSIL.Memoize($asm08.Fusee.Engine.Player.Web.Player_$l$gc)) ();
  };
  var $T08 = function () {
  ...
  var $T0A = function () {
    return ($T0A = JSIL.Memoize($asm25.FuseeApp.MyFirstFusee)) ();
  };
  var $T0B = function () {
  ...
  function Player_Main () {
    ...
    if ((arg_4D_1 = $T07().$l$g9__0_0) === null) {
      arg_4D_1 = $T07().$l$g9__0_0 = $T00().New($T07().$l$g9, null, new JSIL.MethodPointerInfo($asm08.Fusee.Engine.Player.Web.Player_$l$gc, "$lMain$gb__0_0", $S00(), false, false));
    }
    handler.Decoder = arg_4D_1;
    if ((arg_73_1 = $T07().$l$g9__0_1) === null) {
      arg_73_1 = $T07().$l$g9__0_1 = $T01().New($T07().$l$g9, null, new JSIL.MethodPointerInfo($asm08.Fusee.Engine.Player.Web.Player_$l$gc, "$lMain$gb__0_1", $S01(), false, false));
    }
    ...
    if ((arg_BA_1 = $T07().$l$g9__0_2) === null) {
      arg_BA_1 = $T07().$l$g9__0_2 = $T00().New($T07().$l$g9, null, new JSIL.MethodPointerInfo($asm08.Fusee.Engine.Player.Web.Player_$l$gc, "$lMain$gb__0_2", $S02(), false, false));
    }
    handler.Decoder = arg_BA_1;
    if ((arg_E0_1 = $T07().$l$g9__0_3) === null) {
      arg_E0_1 = $T07().$l$g9__0_3 = $T01().New($T07().$l$g9, null, new JSIL.MethodPointerInfo($asm08.Fusee.Engine.Player.Web.Player_$l$gc, "$lMain$gb__0_3", $S03(), false, false));
    }
    handler.Checker = arg_E0_1;
    webAssetProvider.RegisterTypeHandler(handler.MemberwiseClone());
    $T09().RegisterProvider(webAssetProvider);
    var player = new ($T0A())();
    player.RenderCanvas$CanvasImplementor$value = new ($T0C())();
    player.RenderCanvas$ContextImplementor$value = new ($T0D())(player.RenderCanvas$CanvasImplementor$value);
    $T0E().AddDriverImp(new ($T0F())(player.RenderCanvas$CanvasImplementor$value));
    player.Run();
  }; 

  JSIL.MakeType({
      BaseType: $asm0F.TypeRef("System.Object"), 
      Name: "Fusee.Engine.Player.Web.Player", 
      IsPublic: true, 
...
/* class Fusee.Engine.Player.Web.Player+<>c */ 
...
(function $l$gc$Members () {
  ...
  function $l$gc_$lMain$gb__0_2 (id, storage) {
    ...
    if (flag) {
      ...
      var result = (new ($T07())()).Convert($T08().$As($S00().CallVirtual("Deserialize", null, serializer, $T0A().StreamFromFile(JSIL.ConcatString("Assets/", id), $T0B().Open), null, $T08().__Type__)));
    } else {
      result = null;
    }
    return result;
  ...
  JSIL.MakeType({
      BaseType: $asm0F.TypeRef("System.Object"), 
      Name: "Fusee.Engine.Player.Web.Player+<>c", 
      IsPublic: false, 
      IsReferenceType: true, 
      MaximumConstructorArguments: 0, 
    }, function ($ib) {
