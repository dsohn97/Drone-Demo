...
(function ColorUint$Members () {
  ...
  function ColorUint_ToCss () {
    return $T0C().Format("#{0:X2}{1:X2}{2:X2}", $T00().$Box(this.R), $T00().$Box(this.G), $T00().$Box(this.B));
  }; 
    ...
    if (flag) {
      ...
      if (flag2) {
        ...
        if (flag3) {
          ...
          result = ($S07().CallStatic($T01(), "Compare", null, serverAndShare, serverAndShare2, $T0C().get_InvariantCulture(), $T0D().None) | 0) === 0;
        }
      } else {
...
(function ScanLine$Members () {
  ...
  function ScanLine_GetScanLineBytes () {
    var num = Math.imul(this.ScanLine$Width$value, this.get_BytesPerPixel());
...
(function SplitToCurveSegmentHelper$Members () {
  ...
  var $T05 = function () {
    return ($T05 = JSIL.Memoize($asm0F.System.Collections.Generic.IEnumerator$b1.Of($asm0A.Fusee.Math.Core.float3))) ();
  };
  var $T06 = function () {
    return ($T06 = JSIL.Memoize($asm0F.System.Collections.Generic.IEnumerable$b1.Of($asm0A.Fusee.Math.Core.float3))) ();
  };
  var $T07 = function () {
  ...
  var $T09 = function () {
    return ($T09 = JSIL.Memoize($asm0F.System.Collections.Generic.IList$b1.Of($asm0A.Fusee.Math.Core.float3))) ();
  };
  var $T0A = function () {
    return ($T0A = JSIL.Memoize($asm0F.System.Collections.Generic.ICollection$b1.Of($asm0A.Fusee.Math.Core.float3))) ();
  };
  var $T0B = function () {
    return ($T0B = JSIL.Memoize($asm0F.System.IDisposable)) ();
  };
  var $T0C = function () {
    return ($T0C = JSIL.Memoize($asm0F.System.Collections.Generic.ICollection$b1.Of($asm0F.System.Byte))) ();
  };
  var $T0D = function () {
    return ($T0D = JSIL.Memoize($asm0F.System.Collections.Generic.List$b1.Of($asm0A.Fusee.Math.Core.float3))) ();
  };
  var $T0E = function () {
    return ($T0E = JSIL.Memoize($asm15.System.Linq.Enumerable)) ();
  };
  var $T0F = function () {
    return ($T0F = JSIL.Memoize($asm0A.Fusee.Math.Core.LinearSegment)) ();
  };
  var $T10 = function () {
    return ($T10 = JSIL.Memoize($asm0A.Fusee.Math.Core.CurveSegment)) ();
  };
  var $T11 = function () {
    return ($T11 = JSIL.Memoize($asm0A.Fusee.Math.Core.BezierCubicSegment)) ();
  };
  var $T12 = function () {
    return ($T12 = JSIL.Memoize($asm0A.Fusee.Math.Core.BezierConicSegment)) ();
  };
  var $T13 = function () {
    return ($T13 = JSIL.Memoize($asm0F.System.ArgumentOutOfRangeException)) ();
  };
  var $T14 = function () {
    return ($T14 = JSIL.Memoize($asm0F.System.Collections.Generic.ICollection$b1.Of($asm0A.Fusee.Math.Core.CurveSegment))) ();
  };
  var $T15 = function () {
    return ($T15 = JSIL.Memoize($asm0F.System.Collections.Generic.IEnumerator$b1.Of($asm0A.Fusee.Math.Core.CurveSegment))) ();
  };
  var $T16 = function () {
    return ($T16 = JSIL.Memoize($asm0F.System.Collections.Generic.IEnumerable$b1.Of($asm0A.Fusee.Math.Core.CurveSegment))) ();
  };
  var $T17 = function () {
    return ($T17 = JSIL.Memoize($asm00.Fusee.Base.Common.SplitToCurveSegmentHelper_SegmentType)) ();
  };
  var $T18 = function () {
    return ($T18 = JSIL.Memoize($asm0F.System.Collections.Generic.List$b1.Of($asm0F.System.Byte))) ();
  };
  var $T19 = function () {
    return ($T19 = JSIL.Memoize(System.Array.Of($asm0F.System.Byte))) ();
  };
  var $T1A = function () {
    return ($T1A = JSIL.Memoize($asm0F.System.Byte)) ();
  };
  var $T1B = function () {
    return ($T1B = JSIL.Memoize($asm0F.System.Collections.Generic.IEnumerable$b1.Of($asm0F.System.Byte))) ();
  };
  var $S00 = function () {
  ...
  var $S02 = function () {
    return ($S02 = JSIL.Memoize(new JSIL.ConstructorSignature($asm0F.System.Collections.Generic.List$b1.Of($asm0A.Fusee.Math.Core.float3), [$asm0F.TypeRef("System.Collections.Generic.IEnumerable`1", [$asm0A.TypeRef("Fusee.Math.Core.float3")])]))) ();
  };
  var $S03 = function () {
  ...
  var $S07 = function () {
    return ($S07 = JSIL.Memoize(new JSIL.ConstructorSignature($asm0F.System.Collections.Generic.List$b1.Of($asm0A.Fusee.Math.Core.CurveSegment), null))) ();
  };
  var $S08 = function () {
    return ($S08 = JSIL.Memoize(new JSIL.MethodSignature($asm0F.System.Boolean, [$asm0F.TypeRef("System.Collections.Generic.IEnumerable`1", ["!!0"]), $asm0F.TypeRef("System.Collections.Generic.IEnumerable`1", ["!!0"])], ["TSource"]))) ();
  };
  var $S09 = function () {
    return ($S09 = JSIL.Memoize(new JSIL.ConstructorSignature($asm0F.System.Collections.Generic.List$b1.Of($asm0F.System.Byte), null))) ();
  };
  var $IM00 = function () {
  ...
  $loop0: 
    for (var i = 0; i < (segments.get_Count() | 0); i = ((i + 1) | 0)) {
      ...
      var flag2 = $T04().op_Equality(
        JSIL.GetType(segments.get_Item(i)), 
        JSIL.GetType(segments.get_Item(((i + 1) | 0)))
      );
      if (flag2) {
  ...
  function SplitToCurveSegmentHelper_CreateCurveSegment$00 (i, pattern, verts) {
    ...
    $T0D().prototype.AddRange.call(list, $T0E().Take$b1($T08())(
        $T0E().Skip$b1($T08())(verts, i), 
  ...
  function SplitToCurveSegmentHelper_CreateCurveSegment$01 (i, pattern, startPoint, verts) {
    ...
    list.Add(startPoint.MemberwiseClone());
    switch ($thisType.SplitToCurveSegmentHelper$Type$value.valueOf()) {
      case 0: 
        var expr_47 = new ($T0F())();
  ...
  function SplitToCurveSegmentHelper_CreateOnPointsAndAddToList (vertices) {
    var item = new ($T08())();
    var list = $S02().Construct(vertices);
    list.Remove($S03().CallStatic($T0E(), "First$b1", [$asm0A.Fusee.Math.Core.float3], list).MemberwiseClone());
    list.Remove($S04().CallStatic($T0E(), "Last$b1", [$asm0A.Fusee.Math.Core.float3], list).MemberwiseClone());
  ...
  function SplitToCurveSegmentHelper_FixSegments (segments) {
    var float = $S03().CallStatic($T0E(), "First$b1", [$asm0A.Fusee.Math.Core.float3], $S05().CallStatic($T0E(), "First$b1", [$asm0A.Fusee.Math.Core.CurveSegment], segments).Vertices).MemberwiseClone();
    var enumerator = $IM08().Call(segments, null);
    try {

      while ($IM01().Call(enumerator, null)) {
        var current = $IM09().Call(enumerator, null);
        $IM0A().Call(current.Vertices, null, $S03().CallStatic($T0E(), "First$b1", [$asm0A.Fusee.Math.Core.float3], current.Vertices).MemberwiseClone());
      }
    } finally {
      if (enumerator !== null) {
        $IM05().Call(enumerator, null);
    ...
    var flag = $T08().op_Equality(float.MemberwiseClone(), $S04().CallStatic($T0E(), "Last$b1", [$asm0A.Fusee.Math.Core.float3], $S06().CallStatic($T0E(), "Last$b1", [$asm0A.Fusee.Math.Core.CurveSegment], segments).Vertices).MemberwiseClone());
    if (!flag) {
      var expr_74 = new ($T0F())();
  ...
  function SplitToCurveSegmentHelper_SplitPartIntoSegments (part, partTags, partVerts) {
    ...
    for (var i = 0; i < (partTags.get_Count() | 0); i = ((i + 1) | 0)) {
      var flag = $S08().CallStatic($T0E(), "SequenceEqual$b1", [$asm0F.System.Byte], $T0E().Take$b1($T1A())($T0E().Skip$b1($T1A())(partTags, i), array.length), $T1B().$Cast(array));
      if (flag) {
        $thisType.SplitToCurveSegmentHelper$Type$value = $T17().LINEAR;
        list.Add($thisType.CreateCurveSegment(i, $T0C().$Cast(array), partVerts));
      } else {
        var flag2 = $S08().CallStatic($T0E(), "SequenceEqual$b1", [$asm0F.System.Byte], $T0E().Take$b1($T1A())($T0E().Skip$b1($T1A())(partTags, i), array2.length), $T1B().$Cast(array2));
        if (flag2) {
          $thisType.SplitToCurveSegmentHelper$Type$value = $T17().CONIC;
          list.Add($thisType.CreateCurveSegment(i, $T0C().$Cast(array2), partVerts));
          i = ((i + 1) | 0);
        } else {
          var flag3 = $S08().CallStatic($T0E(), "SequenceEqual$b1", [$asm0F.System.Byte], $T0E().Take$b1($T1A())($T0E().Skip$b1($T1A())(partTags, i), array3.length), $T1B().$Cast(array3));
          if (flag3) {
            $thisType.SplitToCurveSegmentHelper$Type$value = $T17().CUBIC;
            list.Add($thisType.CreateCurveSegment(i, $T0C().$Cast(array3), partVerts));
            i = ((i + 2) | 0);
          } else {
            var flag4 = $S08().CallStatic($T0E(), "SequenceEqual$b1", [$asm0F.System.Byte], $T0E().Take$b1($T1A())($T0E().Skip$b1($T1A())(partTags, i), expr_34.length), $T1B().$Cast(expr_34));
            if (flag4) {
              $thisType.SplitToCurveSegmentHelper$Type$value = $T17().CONIC;
              var num = 0;
              var curveSegment = $thisType.CreateCurveSegment(i, $T0C().$Cast(expr_34), partVerts);
              i = ((i + 3) | 0);
            ...
            $loop1: 
              ...
              list.Add(curveSegment);
            } else {
              var list2 = $S09().Construct();
              $T18().prototype.AddRange.call(list2, $T0E().Take$b1($T1A())(
                  $T0E().Skip$b1($T1A())(partTags, i), 
                  (((partTags.get_Count() | 0) - i) | 0)
                ));
              list2.Add(partTags.get_Item(0));
              var flag7 = $S08().CallStatic($T0E(), "SequenceEqual$b1", [$asm0F.System.Byte], list2, $T1B().$Cast(array2));
              if (flag7) {
                list.Add($thisType.CreateCurveSegment(i, $T0C().$Cast(array2), partVerts.get_Item(0).MemberwiseClone(), partVerts));
              } else {
                var flag8 = $S08().CallStatic($T0E(), "SequenceEqual$b1", [$asm0F.System.Byte], list2, $T1B().$Cast(array3));
                if (flag8) {
                  list.Add($thisType.CreateCurveSegment(i, $T0C().$Cast(array3), partVerts.get_Item(0).MemberwiseClone(), partVerts));
                } else {
                  var flag9 = $S08().CallStatic($T0E(), "SequenceEqual$b1", [$asm0F.System.Byte], list2, $T1B().$Cast(expr_34));
                  if (flag9) {
                    list.Add($thisType.CreateCurveSegment(i, $T0C().$Cast(array3), partVerts.get_Item(0).MemberwiseClone(), partVerts));
                  }
                }
