...
(function AssetStorage$Members () {
  ...
  function AssetStorage_DeepCopy$b1 (T, source) {
    ...
    var serializer = new ($T09())();
    var memoryStream = $S02().Construct();
    $S03().CallVirtual("Serialize", null, serializer, memoryStream, JSIL.CloneParameter(T, source));
    memoryStream.set_Position($T0D().Create(0, 0, 0));
    return T.$As($S04().CallVirtual("Deserialize", null, serializer, memoryStream, null, T));
  }; 
  ...
  function AssetStorage_GetAsset$b1 (T, id) {
    ...
    for (var a$0 = this._providers._items, i$0 = 0, l$0 = (this._providers._size | 0); i$0 < l$0; ($temp00 = i$0, 
        ...
        $temp00)) {
      var current = a$0[i$0];
      var flag = $IM00().Call(current, null, id, T);
      if (flag) {
        var result = JSIL.CloneParameter(T, T.$Cast($IM01().Call(current, null, id, T)));
        return result;
      }
    }
    result = (
  ...
  function AssetStorage_RegisterAssetProvider (assetProvider) {
    ...
    (this._providers).Add(assetProvider);
  }; 
...
(function Font$Members () {
  ...
  function Font_GetGlyphCurve (c) {
    var glyphCurve = new JSIL.BoxedVariable(null);
    var flag = (this._glyphCurveChache).TryGetValue(c, /* ref */ glyphCurve);
    if (flag) {
      var result = glyphCurve.get();
    } else {
      glyphCurve.set($IM02().Call(this._fontImp, null, c));
      (this._glyphCurveChache).set_Item(c, glyphCurve.get());
      result = glyphCurve.get();
    }
    return result;
  }; 

  function Font_GetGlyphInfo (c) {
    var glyphInfo = new JSIL.BoxedVariable(new ($T07())());
    var flag = (this._glyphInfoCache).TryGetValue(c, /* ref */ glyphInfo);
    if (flag) {
      var result = glyphInfo.get().MemberwiseClone();
    } else {
      glyphInfo.set($IM03().Call(this._fontImp, null, c).MemberwiseClone());
      (this._glyphInfoCache).set_Item(c, glyphInfo.get().MemberwiseClone());
      result = glyphInfo.get().MemberwiseClone();
    }
    return result;
  }; 
  ...
  function Font_GetUnscaledAdvance (c) {
    var unscaledAdvance = new JSIL.BoxedVariable(0);
    var flag = (this._glyphAdvanceCache).TryGetValue(c, /* ref */ unscaledAdvance);
    if (flag) {
      var result = +unscaledAdvance.get();
    } else {
      unscaledAdvance.set($IM05().Call(this._fontImp, null, c));
      (this._glyphAdvanceCache).set_Item(c, unscaledAdvance.get());
      result = +unscaledAdvance.get();
    }
    return result;
  }; 
...
(function ImageData$Members () {
  ...
  function ImageData_$lBlt$gb__14_5 (srcLineBytes, destinationIndex) {
    ...
    for (var i = 0; i < (srcLineBytes.length | 0); i = ((i + 3) | 0)) {
      var num = (srcLineBytes[(((destinationIndex | 0) + i) | 0)] | 0);
      var num2 = (srcLineBytes[(((((destinationIndex | 0) + i) | 0) + 1) | 0)] | 0);
      var num3 = (srcLineBytes[(((((destinationIndex | 0) + i) | 0) + 2) | 0)] | 0);
      this.ImageData$PixelData$value[(((destinationIndex | 0) + i) | 0)] = (((((((((((((num + num) | 0) + num3) | 0) + num2) | 0) + num2) | 0) + num2) | 0) / 6) | 0) & 0xFF);
    }
  }; 
  ...
  function ImageData_Blt ($xDst, $yDst, src, $xSrc, $ySrc, $width, $height) {
    ...
    if (!flag3) {
      ...
      if (flag4) {
        var copyFunc = $T09().New(this, null, new JSIL.MethodPointerInfo($thisType, "$lBlt$gb__14_0", $S01(), false, false));
      } else {
        switch ((this.get_PixelFormat().ImagePixelFormat$ColorFormat$value).valueOf()) {
          case 0: 
            ...
            if (colorFormat !== $T07().RGB) {
              ...
              copyFunc = $T09().New(this, null, new JSIL.MethodPointerInfo($thisType, "$lBlt$gb__14_2", $S03(), false, false));
            } else {
              copyFunc = $T09().New(this, null, new JSIL.MethodPointerInfo($thisType, "$lBlt$gb__14_1", $S04(), false, false));
            }
            break;
          ...
          case 1: 
            ...
            if ((colorFormat2.valueOf() | 0) !== 0) {
              ...
              copyFunc = $T09().New(this, null, new JSIL.MethodPointerInfo($thisType, "$lBlt$gb__14_4", $S05(), false, false));
            } else {
              copyFunc = $T09().New(this, null, new JSIL.MethodPointerInfo($thisType, "$lBlt$gb__14_3", $S06(), false, false));
            }
            break;
          ...
          case 2: 
            ...
            if ((colorFormat3.valueOf() | 0) !== 0) {
              ...
              copyFunc = $T09().New(this, null, new JSIL.MethodPointerInfo($thisType, "$lBlt$gb__14_5", $S07(), false, false));
            } else {
              copyFunc = $T09().New(this, null, new JSIL.MethodPointerInfo($thisType, "$lBlt$gb__14_6", $S08(), false, false));
            }
            break;
      ...
      for (var enumerator = $IM03().Call(src, null, xSrc.get(), ySrc.get(), width.get(), height.get()); $IM04().Call(enumerator, null); ) {
        var current = $IM05().Call(enumerator, null);
        if (current !== null) {
          var scanLineBytes = current.GetScanLineBytes();
          var dstIndex = ((Math.imul(Math.imul(yDst.get(), (this.get_PixelFormat()).get_BytesPerPixel()), this.get_Width()) + Math.imul(xDst.get(), (this.get_PixelFormat()).get_BytesPerPixel())) | 0);
          copyFunc(scanLineBytes, dstIndex);
  ...
  function ImageData_CreateImage (width, height, color) {
    var num2 = Math.imul(width, height);
    var num3 = Math.imul(num2, 4);
    var array = JSIL.Array.New($T01(), num2);

    for (var i = 0; i < (array.length | 0); i = ((i + 1) | 0)) {
      array[i] = (color.ToBgra() | 0);
    }
    var imageData = new $thisType(JSIL.Array.New($T04(), num3), width, height, new ($T02())($T07().RGBA));
    $T10().BlockCopy(
      array, 
      0, 
      imageData.ImageData$PixelData$value, 
      0, 
      num3
    );
    return imageData;
...
(function ScanLineEnumerator$Members () {
  ...
  function ScanLineEnumerator_GetCurrentScanLine () {
    var num = Math.imul(this._width, (this._pixelFormat).get_BytesPerPixel());
    var array = JSIL.Array.New($T03(), num);
    ...
    return new ($T05())(array, 0, this._width, this._pixelFormat.MemberwiseClone());
  }; 
