...
(function AnimationComponent$Members () {
  var $, $thisType;
  var $T00 = function () {
    return ($T00 = JSIL.Memoize($asm0F.System.Collections.Generic.List$b1.Of($asm0B.Fusee.Serialization.AnimationTrackContainer))) ();
  };
  var $T01 = function () {
    return ($T01 = JSIL.Memoize($asm0B.Fusee.Serialization.SceneComponentContainer)) ();
  };
  var $S00 = function () {
    return ($S00 = JSIL.Memoize(new JSIL.ConstructorSignature($asm0F.System.Collections.Generic.List$b1.Of($asm0B.Fusee.Serialization.AnimationTrackContainer), null))) ();
  };


  function AnimationComponent__ctor () {
    this.AnimationTracks = $S00().Construct();
...
(function AnimationTrackContainer$Members () {
  ...
  var $T01 = function () {
    return ($T01 = JSIL.Memoize($asm0F.System.Collections.Generic.List$b1.Of($asm0B.Fusee.Serialization.AnimationKeyContainerBase))) ();
  };
  var $S00 = function () {
    return ($S00 = JSIL.Memoize(new JSIL.ConstructorSignature($asm0F.System.Collections.Generic.List$b1.Of($asm0B.Fusee.Serialization.AnimationKeyContainerBase), null))) ();
  };


  function AnimationTrackContainer__ctor () {
    this.LerpType = $T00().Lerp;
    this.KeyFrames = $S00().Construct();
  }; 
...
(function CanvasTransformComponent$Members () {
  var $, $thisType;
  var $T00 = function () {
    return ($T00 = JSIL.Memoize($asm0B.Fusee.Serialization.CanvasRenderMode)) ();
  };
  var $T01 = function () {
    return ($T01 = JSIL.Memoize($asm0F.System.Single)) ();
  };
  var $T02 = function () {
    return ($T02 = JSIL.Memoize($asm0B.Fusee.Serialization.SceneComponentContainer)) ();
  };


  function CanvasTransformComponent__ctor (canvasRenderMode, scale) {
    $T02().prototype._ctor.call(this);
    this.CanvasRenderMode = canvasRenderMode;
    this.Scale = +(
      (this.CanvasRenderMode === $T00().SCREEN)
         ? scale
         : 1)
    ;
  }; 
  ...
  JSIL.MakeType({
    ...
    $.Method({Static:false, Public:true }, ".ctor", 
      new JSIL.MethodSignature(null, [$asm0B.TypeRef("Fusee.Serialization.CanvasRenderMode"), $.Single]), 
...
(function Mesh$Members () {
  ...
  function Mesh_Dispose () {
    ...
    var flag = meshChanged !== null;
    if (flag) {
      meshChanged(this, new ($T06())(this, $T07().Disposed));
    }
  }; 
  ...
  function Mesh_set_BiTangents (value) {
    ...
    var flag = meshChanged !== null;
    if (flag) {
      meshChanged(this, new ($T06())(this, $T07().BiTangents));
    }
  }; 
  ...
  function Mesh_set_BoneIndices (value) {
    ...
    var flag = meshChanged !== null;
    if (flag) {
      meshChanged(this, new ($T06())(this, $T07().BoneIndices));
    }
  }; 
  ...
  function Mesh_set_BoneWeights (value) {
    ...
    var flag = meshChanged !== null;
    if (flag) {
      meshChanged(this, new ($T06())(this, $T07().BoneWeights));
    }
  }; 
  ...
  function Mesh_set_Colors (value) {
    ...
    var flag = meshChanged !== null;
    if (flag) {
      meshChanged(this, new ($T06())(this, $T07().Colors));
    }
  }; 
  ...
  function Mesh_set_Normals (value) {
    ...
    var flag = meshChanged !== null;
    if (flag) {
      meshChanged(this, new ($T06())(this, $T07().Normals));
    }
  }; 
  ...
  function Mesh_set_Tangents (value) {
    ...
    var flag = meshChanged !== null;
    if (flag) {
      meshChanged(this, new ($T06())(this, $T07().Tangents));
    }
  }; 
  ...
  function Mesh_set_Triangles (value) {
    ...
    var flag = meshChanged !== null;
    if (flag) {
      meshChanged(this, new ($T06())(this, $T07().Triangles));
    }
  }; 
  ...
  function Mesh_set_UVs (value) {
    ...
    var flag = meshChanged !== null;
    if (flag) {
      meshChanged(this, new ($T06())(this, $T07().Uvs));
    }
  }; 
  ...
  function Mesh_set_Vertices (value) {
    ...
    var flag = meshChanged !== null;
    if (flag) {
      meshChanged(this, new ($T06())(this, $T07().Vertices));
    }
  }; 
...
(function SceneContainer$Members () {
  var $, $thisType;
  var $T00 = function () {
    return ($T00 = JSIL.Memoize($asm0F.System.Collections.Generic.List$b1.Of($asm0B.Fusee.Serialization.SceneNodeContainer))) ();
  };
  var $S00 = function () {
    return ($S00 = JSIL.Memoize(new JSIL.ConstructorSignature($asm0F.System.Collections.Generic.List$b1.Of($asm0B.Fusee.Serialization.SceneNodeContainer), null))) ();
  };
...
(function SceneNodeContainer$Members () {
  var $, $thisType;
  var $T00 = function () {
    return ($T00 = JSIL.Memoize($asm0F.System.Collections.Generic.List$b1.Of($asm0B.Fusee.Serialization.SceneComponentContainer))) ();
  };
  var $T01 = function () {
    return ($T01 = JSIL.Memoize($asm0F.System.Collections.Generic.List$b1.Of($asm0B.Fusee.Serialization.SceneNodeContainer))) ();
  };
  var $S00 = function () {
...
(function ShaderComponent$Members () {
  var $, $thisType;
  var $T00 = function () {
    return ($T00 = JSIL.Memoize($asm0F.System.Collections.Generic.List$b1.Of($asm0B.Fusee.Serialization.RenderPass))) ();
  };
  var $T01 = function () {
    return ($T01 = JSIL.Memoize($asm0F.System.Collections.Generic.List$b1.Of($asm0B.Fusee.Serialization.TypeContainer))) ();
  };
  var $T02 = function () {
    return ($T02 = JSIL.Memoize($asm0B.Fusee.Serialization.SceneComponentContainer)) ();
  };
  var $S00 = function () {
    return ($S00 = JSIL.Memoize(new JSIL.ConstructorSignature($asm0F.System.Collections.Generic.List$b1.Of($asm0B.Fusee.Serialization.RenderPass), null))) ();
  };
  var $S01 = function () {
    return ($S01 = JSIL.Memoize(new JSIL.ConstructorSignature($asm0F.System.Collections.Generic.List$b1.Of($asm0B.Fusee.Serialization.TypeContainer), null))) ();
  };


  function ShaderComponent__ctor () {
    this.EffectPasses = $S00().Construct();
    this.EffectParameter = $S01().Construct();
    $T02().prototype._ctor.call(this);
  }; 
...
(function RenderPass$Members () {
  var $, $thisType;
  var $T00 = function () {
    return ($T00 = JSIL.Memoize($asm0F.System.Collections.Generic.Dictionary$b2.Of($asm0F.System.UInt32, $asm0F.System.UInt32))) ();
  };
  var $S00 = function () {
    return ($S00 = JSIL.Memoize(new JSIL.ConstructorSignature($asm0F.System.Collections.Generic.Dictionary$b2.Of($asm0F.System.UInt32, $asm0F.System.UInt32), null))) ();
  };


  function RenderPass__ctor () {
    this.RenderStateContainer = $S00().Construct();
  }; 
...
(function WeightComponent$Members () {
  var $, $thisType;
  var $T00 = function () {
    return ($T00 = JSIL.Memoize($asm0F.System.Collections.Generic.List$b1.Of($asm0B.Fusee.Serialization.VertexWeightList))) ();
  };
  var $T01 = function () {
    return ($T01 = JSIL.Memoize($asm0F.System.Collections.Generic.List$b1.Of($asm0B.Fusee.Serialization.SceneNodeContainer))) ();
  };
  var $T02 = function () {
    return ($T02 = JSIL.Memoize($asm0F.System.Collections.Generic.List$b1.Of($asm0A.Fusee.Math.Core.float4x4))) ();
  };
  var $T03 = function () {
    return ($T03 = JSIL.Memoize($asm0B.Fusee.Serialization.SceneComponentContainer)) ();
  };
  var $S00 = function () {
    return ($S00 = JSIL.Memoize(new JSIL.ConstructorSignature($asm0F.System.Collections.Generic.List$b1.Of($asm0B.Fusee.Serialization.VertexWeightList), null))) ();
  };
  var $S01 = function () {
    return ($S01 = JSIL.Memoize(new JSIL.ConstructorSignature($asm0F.System.Collections.Generic.List$b1.Of($asm0B.Fusee.Serialization.SceneNodeContainer), null))) ();
  };
  var $S02 = function () {
    return ($S02 = JSIL.Memoize(new JSIL.ConstructorSignature($asm0F.System.Collections.Generic.List$b1.Of($asm0A.Fusee.Math.Core.float4x4), null))) ();
  };


  function WeightComponent__ctor () {
    this.WeightMap = $S00().Construct();
    this.Joints = $S01().Construct();
    this.BindingMatrices = $S02().Construct();
...
/* class Fusee.Serialization.XFormTextComponent */ 

(function XFormTextComponent$Members () {
  var $, $thisType;
  var $T00 = function () {
  ...
  function XFormTextComponent__ctor (textScaleFactor) {
    $T01().prototype._ctor.call(this);
  ...
  JSIL.MakeType({
      BaseType: $asm0B.TypeRef("Fusee.Serialization.SceneComponentContainer"), 
      Name: "Fusee.Serialization.XFormTextComponent", 
      IsPublic: true, 
      IsReferenceType: true, 
      MaximumConstructorArguments: 1, 
    }, function ($ib) {
    ...
    $.Method({Static:false, Public:true }, ".ctor", 
      ...
      XFormTextComponent__ctor
    );

    $.Field({Static:false, Public:true }, "TextScaleFactor", $.Single);
